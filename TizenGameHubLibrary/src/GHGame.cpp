...
GHGame::GHGame(long _id, long _developerId, STRING _title, STRING _description, STRING _imgUrl,
...
: id(_id), developerId(_developerId), leaderboardCount(_leaderboardCount), achievementCount(_achievementCount), attackhelperCount(_attackhelperCount)
