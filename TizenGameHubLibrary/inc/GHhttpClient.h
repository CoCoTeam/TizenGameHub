...
public:
	...
	/*result RequestImageDownload(Tizen::Net::Http::IHttpTransactionEventListener* listener, Tizen::Net::Http::IHttpProgressEventListener* listener2, Tizen::Base::String url);	// url+[filename] ->download    ==>  byte array -> file로 만들고 <device 폴더>를 만들고 거기에 저장	"pkeykichul_20140417153111.png"*/
