...
void
Form2::OnUserEventReceivedN (RequestId requestId, Tizen::Base::Collection::IList *pArgs)
...
void Form2::ShowPopup(Popup* __pPopup) {
	__pPopup->SetShowState(true);
	__pPopup->Show();
}

void Form2::HidePopup(Popup* __pPopup) {
...
// timer 작동
void
Form2::OnTimerExpired(Timer&  timer)
{
	SetTimer();
