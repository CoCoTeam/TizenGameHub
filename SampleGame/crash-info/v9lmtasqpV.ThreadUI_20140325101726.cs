...
PID: 5673
Date: 2014-03-25 10:17:26(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 5673, uid 5000)

Register Information
gs  = 0x00000033, fs  = 0x00000000
es  = 0x0000007b, ds  = 0x0000007b
edi = 0xb7335ff4, esi = 0xb7310043
ebp = 0xbf9a4e88, esp = 0xbf9a4e70
eax = 0x00000000, ebx = 0x00001629
ecx = 0x00001629, edx = 0x00000006
eip = 0xb76f1424
...
b2120000 b2122000 r-xp /usr/lib/libhaptic-module.so
b22ff000 b230d000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnu-i686-1.7.99/module.so
b230e000 b231c000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnu-i686-1.7.99/module.so
b2325000 b2342000 r-xp /opt/usr/apps/v9lmtasqpV/bin/ThreadUI.exe
...
b713f000 b7141000 r-xp /opt/usr/apps/v9lmtasqpV/bin/ThreadUI
...
Callstack Information (PID:5673)
Call Stack Count: 24
 ...
 2: Tizen::Ui::Controls::Label::SetText(Tizen::Base::String const&) + 0x63 (0xb3565803) [/usr/lib/osp/libosp-uifw.so] + 0x45b803
 3: Mode2::SetTimer() + 0x6f1 (0xb2338d51) [/opt/apps/v9lmtasqpV/bin/ThreadUI.exe] + 0x13d51
 4: Mode2::OnTimerExpired(Tizen::Base::Runtime::Timer&) + 0x41 (0xb23390f1) [/opt/apps/v9lmtasqpV/bin/ThreadUI.exe] + 0x140f1
 5: non-virtual thunk to Mode2::OnTimerExpired(Tizen::Base::Runtime::Timer&) + 0x45 (0xb2339325) [/opt/apps/v9lmtasqpV/bin/ThreadUI.exe] + 0x14325
End of Call Stack
