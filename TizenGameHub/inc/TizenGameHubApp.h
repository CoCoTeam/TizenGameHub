#ifndef _TIZEN_GAME_HUB_APP_H_
#define _TIZEN_GAME_HUB_APP_H_
...
//  The TizenGameHubApp class must inherit from the UiApp class,
//  which provides the basic features necessary to define a UI application.
 
class TizenGameHubApp
...
public:
	...
	TizenGameHubApp(void);
	virtual ~TizenGameHubApp(void);
