...
AppGHLeaderboardRankProvider::AppGHLeaderboardRankProvider() {
...
int AppGHLeaderboardRankProvider::GetItemCount(void)
{
	AppLog("[LeaderboardRankProvider] Rank List Count : %d",list.GetCount());
	return list.GetCount();
}
Tizen::Ui::Controls::ListItemBase* AppGHLeaderboardRankProvider::CreateItem(int index, int itemWidth)
{
...
bool AppGHLeaderboardRankProvider::DeleteItem
(int index, Tizen::Ui::Controls::ListItemBase* pItem, int itemWidth)
{
	return false;
}
void AppGHLeaderboardRankProvider::addItemList(Tizen::Base::Collection::ArrayList* _list)
{
...
void AppGHLeaderboardRankProvider::setUnit(Tizen::Base::String _unit)
{
	unit = _unit;
}
