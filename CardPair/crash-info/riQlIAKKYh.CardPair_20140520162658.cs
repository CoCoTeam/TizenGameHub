...
PID: 17094
Date: 2014-05-20 16:26:58(GMT+0900)
...
r6   = 0x0033a384, r7   = 0x0033a2e8
r8   = 0x0033a2e8, r9   = 0x000073b8
r10  = 0x0033a384, fp   = 0x00006eb8
...
b2627000 b267c000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
...
Call Stack Count: 32
 ...
 4: FormMain::loadCloudsaveFinished(int, Tizen::Base::String) + 0x150 (0xb26a79f4) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x1f9f4
 5: non-virtual thunk to FormMain::loadCloudsaveFinished(int, Tizen::Base::String) + 0x30 (0xb26a7d18) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x1fd18
 6: GHCloudsaveController::OnTransactionReadyToRead(Tizen::Base::String, Tizen::Base::String, Tizen::Web::Json::IJsonValue*) + 0x468 (0xb2667bec) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x40bec
 7: GHController::OnTransactionReadyToRead(Tizen::Net::Http::HttpSession&, Tizen::Net::Http::HttpTransaction&, int) + 0x3b8 (0xb26457f0) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1e7f0
End of Call Stack
