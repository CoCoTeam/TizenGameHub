...
PID: 17640
Date: 2014-04-29 23:26:06(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 17640, uid 5000)

Register Information
r0   = 0x001b7bc8, r1   = 0x0055e170
r2   = 0xbe9ec85c, r3   = 0x00000000
r4   = 0xb263d938, r5   = 0xb263d996
r6   = 0x0060a550, r7   = 0x001d00b0
r8   = 0xb25b7e78, r9   = 0x000cf238
r10  = 0x00000033, fp   = 0xbe9ec898
ip   = 0x00159460, sp   = 0xbe9ec7c8
lr   = 0xb4244e9d, pc   = 0xb2658370
cpsr = 0x60000010
...
Callstack Information (PID:17640)
Call Stack Count: 28
 0: FormGameMulti::shuffleCard(Tizen::Base::String) + 0xf0 (0xb2658370) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x11370
 1: FormGameMulti::onMatchStart(Tizen::Base::String) + 0x84 (0xb2659748) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x12748
 2: non-virtual thunk to FormGameMulti::onMatchStart(Tizen::Base::String) + 0x24 (0xb26597c0) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x127c0
