...
PID: 13674
Date: 2014-04-29 17:37:14(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 13674, uid 5000)

Register Information
r0   = 0x001a82f0, r1   = 0x00000000
r2   = 0xbe9ec874, r3   = 0x001da568
r4   = 0xb263e938, r5   = 0xb263e996
r6   = 0x001cf230, r7   = 0x00604f78
r8   = 0xb25b8e78, r9   = 0x001aa1a8
r10  = 0x00000033, fp   = 0xbe9ec898
ip   = 0x001da568, sp   = 0xbe9ec7c8
lr   = 0xb4244e9d, pc   = 0xb26591e4
cpsr = 0x60000010
...
Callstack Information (PID:13674)
Call Stack Count: 28
 0: FormGameMulti::shuffleCard(Tizen::Base::String) + 0x104 (0xb26591e4) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x111e4
 1: FormGameMulti::onMatchStart(Tizen::Base::String) + 0x8c (0xb265a0bc) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x120bc
 2: non-virtual thunk to FormGameMulti::onMatchStart(Tizen::Base::String) + 0x24 (0xb265a140) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x12140
 3: GHTurnbasedMatchController::ReceiveData(ListenerType::Type, Tizen::Base::String) + 0x148 (0xb26230b0) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1e0b0
 4: GHSocket::ReceiveData() + 0x494 (0xb26223f4) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1d3f4
 5: GHSocket::OnSocketReadyToReceive(Tizen::Net::Sockets::Socket&) + 0x58 (0xb2621f38) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cf38
End of Call Stack
