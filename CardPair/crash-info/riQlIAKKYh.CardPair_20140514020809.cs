...
PID: 21553
Date: 2014-05-14 02:08:09(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 21553, uid 5000)

Register Information
r0   = 0x003c4058, r1   = 0x40868000
r2   = 0x40868000, r3   = 0xbea01e48
r4   = 0xb26ce7b1, r5   = 0xb26ce732
r6   = 0xfffed0d1, r7   = 0xfffc3b94
r8   = 0x00000002, r9   = 0xb25ee1ec
r10  = 0x003c4058, fp   = 0xbea01d50
ip   = 0xb6c914b8, sp   = 0xbea01c00
lr   = 0xb6be46b8, pc   = 0xb26c4520
cpsr = 0x28000010
...
000dc000 00b1f000 rw-p [heap]
b2478000 b247d000 r-xp /usr/lib/libhaptic-module.so
b2485000 b2487000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b24bc000 b24bf000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b24c7000 b24c8000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b24d0000 b24da000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b2506000 b251a000 r-xp /usr/lib/libnetwork.so.0.0.0
b2523000 b2537000 r-xp /usr/lib/libwifi-direct.so.0.0
b253f000 b2547000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b2548000 b2551000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b2559000 b261e000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b262c000 b2649000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b2652000 b266c000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b2676000 b267f000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b2688000 b26d7000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
b26e3000 b2705000 r-xp /opt/usr/apps/riQlIAKKYh/bin/CardPair.exe
...
Callstack Information (PID:21553)
Call Stack Count: 26
 0: GHCloudsaveController::OnTransactionReadyToRead(Tizen::Base::String, Tizen::Base::String, Tizen::Web::Json::IJsonValue*) + 0x108 (0xb26c4520) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x3c520
 1: GHController::OnTransactionReadyToRead(Tizen::Net::Http::HttpSession&, Tizen::Net::Http::HttpTransaction&, int) + 0x30c (0xb26a55ac) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1d5ac
 2: (0xb25a228f) [/usr/lib/osp/libosp-net.so.1] + 0x4928f
 ...
 6: (0xb25a28ff) [/usr/lib/osp/libosp-net.so.1] + 0x498ff
 7: (0xb25a1a1f) [/usr/lib/osp/libosp-net.so.1] + 0x48a1f
 8: Tizen::Net::Http::_HttpTransactionImpl::OnSocketReceivedEvent(_GIOChannel*, GIOCondition, void*) + 0x80 (0xb25a7075) [/usr/lib/osp/libosp-net.so.1] + 0x4e075
...
20: OspMain + 0x1ac (0xb26f1330) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xe330
