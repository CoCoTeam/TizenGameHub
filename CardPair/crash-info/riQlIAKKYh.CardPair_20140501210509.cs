...
PID: 3468
Date: 2014-05-01 21:05:09(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 3468, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x005b22f8
r2   = 0x00000001, r3   = 0x00000000
r4   = 0xb2641918, r5   = 0xb2641976
r6   = 0x005ece40, r7   = 0x00607208
r8   = 0xb25bbe78, r9   = 0x005e8cc8
r10  = 0x00000037, fp   = 0xbec818f8
ip   = 0x00000000, sp   = 0xbec81728
lr   = 0xb4247e5f, pc   = 0xb265d8d8
cpsr = 0x60000010
...
b2247000 b2249000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b231b000 b232c000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b2417000 b241c000 r-xp /usr/lib/libhaptic-module.so
b2428000 b242d000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b2462000 b2465000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b246d000 b246e000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b2476000 b2480000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b24ac000 b24c0000 r-xp /usr/lib/libnetwork.so.0.0.0
b24c9000 b24dd000 r-xp /usr/lib/libwifi-direct.so.0.0
b24e5000 b24ed000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b24ee000 b24f7000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b24ff000 b25c4000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b25d2000 b25ec000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b25f6000 b25ff000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b2608000 b2648000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
b264b000 b2667000 r-xp /opt/usr/apps/riQlIAKKYh/bin/CardPair.exe
...
Callstack Information (PID:3468)
Call Stack Count: 27
 0: FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x1b0 (0xb265d8d8) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x128d8
 1: non-virtual thunk to FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x24 (0xb265de54) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x12e54
 2: GHTurnbasedMatchController::ReceiveData(ListenerType::Type, Tizen::Base::String) + 0x1d8 (0xb2626124) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1e124
 3: GHSocket::ReceiveData() + 0x494 (0xb26253d8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1d3d8
 4: GHSocket::OnSocketReadyToReceive(Tizen::Net::Sockets::Socket&) + 0x58 (0xb2624f1c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cf1c
End of Call Stack
