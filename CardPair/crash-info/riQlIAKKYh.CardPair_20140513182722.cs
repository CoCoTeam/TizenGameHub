...
PID: 15702
Date: 2014-05-13 18:27:22(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 15702, uid 5000)

Register Information
r0   = 0x00000004, r1   = 0x00000000
r2   = 0x00000004, r3   = 0x05d48860
r4   = 0xbea01674, r5   = 0x001ee118
r6   = 0xb265ecb1, r7   = 0xfffc3b94
r8   = 0x00000002, r9   = 0xb25ef1ec
r10  = 0x00588660, fp   = 0xbea01690
ip   = 0xb26e2b50, sp   = 0xbea01618
lr   = 0xb26a7314, pc   = 0xb42e7534
cpsr = 0x88000030
...
000dc000 0068a000 rw-p [heap]
b0e4f000 b0e54000 r-xp /usr/lib/libhaptic-module.so
b2376000 b2387000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b2475000 b2477000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b2483000 b2488000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b24bd000 b24c0000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b24c8000 b24c9000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b24d1000 b24db000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b2507000 b251b000 r-xp /usr/lib/libnetwork.so.0.0.0
b2524000 b2538000 r-xp /usr/lib/libwifi-direct.so.0.0
b2540000 b2548000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b2549000 b2552000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b255a000 b261f000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b262d000 b264a000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b2653000 b266d000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b2677000 b2680000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b2689000 b26d8000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
b26e4000 b2705000 r-xp /opt/usr/apps/riQlIAKKYh/bin/CardPair.exe
...
Callstack Information (PID:15702)
Call Stack Count: 28
 0: Tizen::Base::String::GetLength() const + 0x3 (0xb42e7534) [/usr/lib/osp/libosp-appfw.so] + 0x130534
 1: GHController::getStringByKey(Tizen::Web::Json::JsonObject*, Tizen::Base::String const*) + 0x7c (0xb26a7314) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1e314
 2: GHAttackhelperController::OnTransactionReadyToRead(Tizen::Base::String, Tizen::Base::String, Tizen::Web::Json::IJsonValue*) + 0x10a4 (0xb26ca080) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x41080
 3: GHController::OnTransactionReadyToRead(Tizen::Net::Http::HttpSession&, Tizen::Net::Http::HttpTransaction&, int) + 0x30c (0xb26a6c1c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1dc1c
 4: (0xb25a328f) [/usr/lib/osp/libosp-net.so.1] + 0x4928f
 5: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2c0 (0xb430d1c5) [/usr/lib/osp/libosp-appfw.so] + 0x1561c5
 6: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb430d3fb) [/usr/lib/osp/libosp-appfw.so] + 0x1563fb
 7: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb430d4ed) [/usr/lib/osp/libosp-appfw.so] + 0x1564ed
 8: (0xb25a38ff) [/usr/lib/osp/libosp-net.so.1] + 0x498ff
 9: (0xb25a2a1f) [/usr/lib/osp/libosp-net.so.1] + 0x48a1f
10: Tizen::Net::Http::_HttpTransactionImpl::OnSocketReceivedEvent(_GIOChannel*, GIOCondition, void*) + 0x80 (0xb25a8075) [/usr/lib/osp/libosp-net.so.1] + 0x4e075
11: g_io_unix_dispatch + 0x2a (0xb6d61783) [/usr/lib/libglib-2.0.so.0] + 0x64783
12: g_main_context_dispatch + 0xce (0xb6d35a37) [/usr/lib/libglib-2.0.so.0] + 0x38a37
13: _ecore_glib_select + 0x3ae (0xb6953337) [/usr/lib/libecore.so.1] + 0xf337
14: _ecore_main_select + 0x294 (0xb694e8b9) [/usr/lib/libecore.so.1] + 0xa8b9
15: _ecore_main_loop_iterate_internal + 0x2de (0xb694f2f3) [/usr/lib/libecore.so.1] + 0xb2f3
16: ecore_main_loop_begin + 0x30 (0xb694f5cd) [/usr/lib/libecore.so.1] + 0xb5cd
17: elm_run + 0x6 (0xb6a1819f) [/usr/lib/libelementary.so.1] + 0xa819f
18: appcore_efl_main + 0x2d4 (0xb6f817d5) [/usr/lib/libappcore-efl.so.1] + 0x27d5
19: app_efl_main + 0xc6 (0xb3f5907f) [/usr/lib/libcapi-appfw-application.so.0] + 0x807f
20: Tizen::App::_AppImpl::Execute(Tizen::App::_IAppImpl*) + 0xe6 (0xb42a48b3) [/usr/lib/osp/libosp-appfw.so] + 0xed8b3
21: Tizen::App::UiApp::Execute(Tizen::App::UiApp* (*)(), Tizen::Base::Collection::IList const*) + 0x64 (0xb3b37231) [/usr/lib/osp/libosp-uifw.so] + 0x6ab231
22: OspMain + 0x1ac (0xb26f1c9c) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xdc9c
23: main + 0x194 (0xb4184f21) [/opt/apps/riQlIAKKYh/bin/CardPair] + 0xf21
24: __launchpad_main_loop + 0xe54 (0xb259) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xb259
25: main + 0x486 (0xbcb3) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xbcb3
26: __libc_start_main + 0x114 (0xb6b7f6e8) [/lib/libc.so.6] + 0x156e8
27: (0xa110) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xa110
End of Call Stack
