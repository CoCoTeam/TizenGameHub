...
PID: 15284
Date: 2014-04-29 18:30:26(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 15284, uid 5000)

Register Information
r0   = 0x0060a9d8, r1   = 0x00000000
r2   = 0xbe9ec86c, r3   = 0x00625cc8
r4   = 0xb263e938, r5   = 0xb263e996
r6   = 0x001fa9e8, r7   = 0x001b7790
r8   = 0xb25b8e78, r9   = 0x003c1e70
r10  = 0x00000033, fp   = 0xbe9ec898
ip   = 0x00625cc8, sp   = 0xbe9ec7c0
lr   = 0xb4244e9d, pc   = 0xb26592cc
cpsr = 0x60000010
...
Callstack Information (PID:15284)
Call Stack Count: 28
 0: FormGameMulti::shuffleCard(Tizen::Base::String) + 0x19c (0xb26592cc) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x112cc
 1: FormGameMulti::onMatchStart(Tizen::Base::String) + 0x8c (0xb265a0fc) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x120fc
 2: non-virtual thunk to FormGameMulti::onMatchStart(Tizen::Base::String) + 0x24 (0xb265a180) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x12180
