...
PID: 3563
Date: 2014-05-06 15:40:05(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 3563, uid 5000)

Register Information
r0   = 0x00000011, r1   = 0x006f1a2c
r2   = 0x00000011, r3   = 0x006f1418
r4   = 0xb2689918, r5   = 0x006f1a2c
r6   = 0x0099db68, r7   = 0x006d0940
r8   = 0xb2603e78, r9   = 0x00b5e628
r10  = 0x0000003c, fp   = 0xbe9116e0
ip   = 0xb26b8f60, sp   = 0xbe911670
lr   = 0xb379a6a5, pc   = 0xb38c4c98
cpsr = 0x60000030
...
Callstack Information (PID:3563)
Call Stack Count: 30
 0: (0xb38c4c98) [/usr/lib/osp/libosp-uifw.so] + 0x48ec98
 1: Tizen::Ui::Controls::Button::SetText(Tizen::Base::String const&) + 0x8 (0xb379a6a5) [/usr/lib/osp/libosp-uifw.so] + 0x3646a5
 2: FormGame::setCardVisible(int, bool) + 0x60 (0xb26a24a8) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xf4a8
 3: FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x654 (0xb26a6470) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x13470
 4: non-virtual thunk to FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x24 (0xb26a6644) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x13644
 5: GHTurnbasedMatchController::ReceiveData(ListenerType::Type, Tizen::Base::String) + 0x1d8 (0xb266e124) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1e124
 6: GHSocket::ReceiveData() + 0x494 (0xb266d3d8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1d3d8
 7: GHSocket::OnSocketReadyToReceive(Tizen::Net::Sockets::Socket&) + 0x58 (0xb266cf1c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cf1c
End of Call Stack
