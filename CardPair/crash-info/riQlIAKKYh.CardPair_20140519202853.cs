...
PID: 28836
Date: 2014-05-19 20:28:53(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 28836, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0xbea02160
r2   = 0xb44c6330, r3   = 0x00000000
r4   = 0x002ac038, r5   = 0xbea021e0
r6   = 0x003ae018, r7   = 0x00430c20
r8   = 0x00000000, r9   = 0x00430c20
r10  = 0xbea02130, fp   = 0xbea02190
ip   = 0xb3df0168, sp   = 0xbea02108
lr   = 0xb3b0900b, pc   = 0xb3b0900c
cpsr = 0x68000030
...
000dc000 00996000 rw-p [heap]
b0e43000 b0e48000 r-xp /usr/lib/libhaptic-module.so
b236a000 b237b000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b2469000 b246b000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b2477000 b247c000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b24b1000 b24b4000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b24bc000 b24bd000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b24c5000 b24cf000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b24fb000 b250f000 r-xp /usr/lib/libnetwork.so.0.0.0
b2518000 b252c000 r-xp /usr/lib/libwifi-direct.so.0.0
b2534000 b253c000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b253d000 b2546000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b254e000 b2613000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b2621000 b263e000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b2647000 b2661000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b266b000 b2674000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b267d000 b26d4000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
b26e0000 b2705000 r-xp /opt/usr/apps/riQlIAKKYh/bin/CardPair.exe
...
Callstack Information (PID:28836)
Call Stack Count: 32
 0: (0xb3b0900c) [/usr/lib/osp/libosp-uifw.so] + 0x67d00c
 1: Tizen::Graphics::_Text::TextObject::DrawByLine(Tizen::Graphics::_CanvasImpl&, Tizen::Graphics::FloatRectangle const&) + 0x3c (0xb3b21e49) [/usr/lib/osp/libosp-uifw.so] + 0x695e49
 2: Tizen::Graphics::_Text::TextObject::Draw(Tizen::Graphics::_CanvasImpl&) + 0x36c (0xb3b26e4d) [/usr/lib/osp/libosp-uifw.so] + 0x69ae4d
 3: (0xb38b05f7) [/usr/lib/osp/libosp-uifw.so] + 0x4245f7
 4: (0xb38b066f) [/usr/lib/osp/libosp-uifw.so] + 0x42466f
 5: Tizen::Ui::Controls::_Label::OnDraw() + 0xa (0xb38ad81f) [/usr/lib/osp/libosp-uifw.so] + 0x42181f
 6: Tizen::Ui::_ControlImpl::OnDraw() + 0x10 (0xb374f8b1) [/usr/lib/osp/libosp-uifw.so] + 0x2c38b1
 7: Tizen::Ui::_Control::ControlVisualElementContentProvider::PrepareDraw(Tizen::Ui::Animations::VisualElement&) + 0xb6 (0xb374bd0f) [/usr/lib/osp/libosp-uifw.so] + 0x2bfd0f
 8: Tizen::Ui::Animations::_VisualElementImpl::InvokePrepareDraw() + 0x16 (0xb36d415b) [/usr/lib/osp/libosp-uifw.so] + 0x24815b
 9: Tizen::Ui::Animations::_VisualElementImpl::DrawRectangle(Tizen::Graphics::FloatRectangle const&) + 0x2d4 (0xb36d446d) [/usr/lib/osp/libosp-uifw.so] + 0x24846d
10: Tizen::Ui::Animations::_VisualElementImpl::DrawForAnimation() + 0x2a (0xb36d482b) [/usr/lib/osp/libosp-uifw.so] + 0x24882b
11: Tizen::Ui::Animations::_VisualElementImpl::DrawForAnimation() + 0x6c (0xb36d486d) [/usr/lib/osp/libosp-uifw.so] + 0x24886d
12: Tizen::Ui::Animations::_VisualElementImpl::DrawForAnimation() + 0x6c (0xb36d486d) [/usr/lib/osp/libosp-uifw.so] + 0x24886d
13: Tizen::Ui::Animations::_VisualElementImpl::DrawForAnimation() + 0x6c (0xb36d486d) [/usr/lib/osp/libosp-uifw.so] + 0x24886d
14: (0xb36c3925) [/usr/lib/osp/libosp-uifw.so] + 0x237925
15: (0xb36c0057) [/usr/lib/osp/libosp-uifw.so] + 0x234057
16: (0xb36c00d3) [/usr/lib/osp/libosp-uifw.so] + 0x2340d3
17: (0xb36e34ab) [/usr/lib/osp/libosp-uifw.so] + 0x2574ab
18: _ecore_idle_enterer_call + 0x48 (0xb694db85) [/usr/lib/libecore.so.1] + 0x9b85
19: _ecore_main_loop_iterate_internal + 0x42 (0xb694f057) [/usr/lib/libecore.so.1] + 0xb057
20: ecore_main_loop_begin + 0x30 (0xb694f5cd) [/usr/lib/libecore.so.1] + 0xb5cd
21: elm_run + 0x6 (0xb6a1819f) [/usr/lib/libelementary.so.1] + 0xa819f
22: appcore_efl_main + 0x2d4 (0xb6f817d5) [/usr/lib/libappcore-efl.so.1] + 0x27d5
23: app_efl_main + 0xc6 (0xb3f5907f) [/usr/lib/libcapi-appfw-application.so.0] + 0x807f
24: Tizen::App::_AppImpl::Execute(Tizen::App::_IAppImpl*) + 0xe6 (0xb42a48b3) [/usr/lib/osp/libosp-appfw.so] + 0xed8b3
25: Tizen::App::UiApp::Execute(Tizen::App::UiApp* (*)(), Tizen::Base::Collection::IList const*) + 0x64 (0xb3b37231) [/usr/lib/osp/libosp-uifw.so] + 0x6ab231
26: OspMain + 0x1ac (0xb26ef04c) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xf04c
27: main + 0x194 (0xb4184f21) [/opt/apps/riQlIAKKYh/bin/CardPair] + 0xf21
28: __launchpad_main_loop + 0xe54 (0xb259) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xb259
29: main + 0x486 (0xbcb3) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xbcb3
30: __libc_start_main + 0x114 (0xb6b7f6e8) [/lib/libc.so.6] + 0x156e8
31: (0xa110) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xa110
End of Call Stack
