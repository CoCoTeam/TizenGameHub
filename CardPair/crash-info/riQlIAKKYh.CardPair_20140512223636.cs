...
PID: 21571
Date: 2014-05-12 22:36:36(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 21571, uid 5000)

Register Information
r0   = 0x0032a200, r1   = 0x00000001
r2   = 0x00000005, r3   = 0xb36e2f3d
r4   = 0xb267f351, r5   = 0xb267f2d2
r6   = 0xfffedbe9, r7   = 0xfffc3b94
r8   = 0x00000002, r9   = 0xb25a21ec
r10  = 0x0032a204, fp   = 0xbe908d20
ip   = 0xb6a4fb98, sp   = 0xbe9088d8
lr   = 0xb429356b, pc   = 0xb267a520
cpsr = 0x20000010
...
b0e02000 b0e07000 r-xp /usr/lib/libhaptic-module.so
b2329000 b233a000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b2428000 b242a000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b2436000 b243b000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b2470000 b2473000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b247b000 b247c000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b2484000 b248e000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b24ba000 b24ce000 r-xp /usr/lib/libnetwork.so.0.0.0
b24d7000 b24eb000 r-xp /usr/lib/libwifi-direct.so.0.0
b24f3000 b24fb000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b24fc000 b2505000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b250d000 b25d2000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b25e0000 b25fd000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b2606000 b2620000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b262a000 b2633000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b263c000 b2688000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
b2693000 b26b2000 r-xp /opt/usr/apps/riQlIAKKYh/bin/CardPair.exe
...
be8ea000 be90b000 rwxp [stack]
End of Maps Information

Callstack Information (PID:21571)
Call Stack Count: 27
 0: GHAttackhelperController::OnTransactionReadyToRead(Tizen::Base::String, Tizen::Base::String, Tizen::Web::Json::IJsonValue*) + 0xd08 (0xb267a520) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x3e520
 1: non-virtual thunk to GHAttackhelperController::OnTransactionReadyToRead(Tizen::Base::String, Tizen::Base::String, Tizen::Web::Json::IJsonValue*) + 0x34 (0xb267a6f8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x3e6f8
 2: GHController::OnTransactionReadyToRead(Tizen::Net::Http::HttpSession&, Tizen::Net::Http::HttpTransaction&, int) + 0x30c (0xb265984c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1d84c
 3: (0xb255628f) [/usr/lib/osp/libosp-net.so.1] + 0x4928f
 4: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2c0 (0xb42ba1c5) [/usr/lib/osp/libosp-appfw.so] + 0x1561c5
 5: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb42ba3fb) [/usr/lib/osp/libosp-appfw.so] + 0x1563fb
 6: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb42ba4ed) [/usr/lib/osp/libosp-appfw.so] + 0x1564ed
 7: (0xb25568ff) [/usr/lib/osp/libosp-net.so.1] + 0x498ff
 8: (0xb2555a1f) [/usr/lib/osp/libosp-net.so.1] + 0x48a1f
 9: Tizen::Net::Http::_HttpTransactionImpl::OnSocketReceivedEvent(_GIOChannel*, GIOCondition, void*) + 0x80 (0xb255b075) [/usr/lib/osp/libosp-net.so.1] + 0x4e075
10: g_io_unix_dispatch + 0x2a (0xb6d0e783) [/usr/lib/libglib-2.0.so.0] + 0x64783
11: g_main_context_dispatch + 0xce (0xb6ce2a37) [/usr/lib/libglib-2.0.so.0] + 0x38a37
12: _ecore_glib_select + 0x3ae (0xb6900337) [/usr/lib/libecore.so.1] + 0xf337
13: _ecore_main_select + 0x294 (0xb68fb8b9) [/usr/lib/libecore.so.1] + 0xa8b9
14: _ecore_main_loop_iterate_internal + 0x2de (0xb68fc2f3) [/usr/lib/libecore.so.1] + 0xb2f3
15: ecore_main_loop_begin + 0x30 (0xb68fc5cd) [/usr/lib/libecore.so.1] + 0xb5cd
16: elm_run + 0x6 (0xb69c519f) [/usr/lib/libelementary.so.1] + 0xa819f
17: appcore_efl_main + 0x2d4 (0xb6f2e7d5) [/usr/lib/libappcore-efl.so.1] + 0x27d5
18: app_efl_main + 0xc6 (0xb3f0607f) [/usr/lib/libcapi-appfw-application.so.0] + 0x807f
19: Tizen::App::_AppImpl::Execute(Tizen::App::_IAppImpl*) + 0xe6 (0xb42518b3) [/usr/lib/osp/libosp-appfw.so] + 0xed8b3
20: Tizen::App::UiApp::Execute(Tizen::App::UiApp* (*)(), Tizen::Base::Collection::IList const*) + 0x64 (0xb3ae4231) [/usr/lib/osp/libosp-uifw.so] + 0x6ab231
21: OspMain + 0x1ac (0xb269fc4c) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xcc4c
22: main + 0x194 (0xb4131f21) [/opt/apps/riQlIAKKYh/bin/CardPair] + 0xf21
...
25: __libc_start_main + 0x114 (0xb6b2c6e8) [/lib/libc.so.6] + 0x156e8
