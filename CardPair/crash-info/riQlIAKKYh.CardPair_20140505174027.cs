...
PID: 30291
Date: 2014-05-05 17:40:27(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 30291, uid 5000)

Register Information
r0   = 0xbe9ec618, r1   = 0xb4423418
r2   = 0x00000000, r3   = 0x00000019
r4   = 0xbe9ec618, r5   = 0x0017a428
r6   = 0xb4243da9, r7   = 0x000000f8
r8   = 0xb4430940, r9   = 0x001c3ae8
r10  = 0x00000034, fp   = 0xbe9ec6c8
ip   = 0xb443377c, sp   = 0xbe9ec5f0
lr   = 0xb4244d7f, pc   = 0xb4244d92
cpsr = 0x40000030
...
000dc000 009cc000 rw-p [heap]
b230c000 b230e000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
...
b2646000 b2663000 r-xp /opt/usr/apps/riQlIAKKYh/bin/CardPair.exe
...
Callstack Information (PID:30291)
Call Stack Count: 31
 0: Tizen::Base::String::String(Tizen::Base::String const&) + 0x25 (0xb4244d92) [/usr/lib/osp/libosp-appfw.so] + 0x130d92
 1: (0xb3878111) [/usr/lib/osp/libosp-uifw.so] + 0x48f111
 2: Tizen::Ui::Controls::Button::SetText(Tizen::Base::String const&) + 0x18 (0xb374d6b5) [/usr/lib/osp/libosp-uifw.so] + 0x3646b5
 3: FormGame::setCardVisible(int, bool) + 0x60 (0xb2655524) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xf524
 4: FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x7e4 (0xb2659740) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x13740
 5: non-virtual thunk to FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x24 (0xb265981c) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x1381c
 6: GHTurnbasedMatchController::ReceiveData(ListenerType::Type, Tizen::Base::String) + 0x1d8 (0xb2621124) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1e124
 7: GHSocket::ReceiveData() + 0x494 (0xb26203d8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1d3d8
 8: GHSocket::OnSocketReadyToReceive(Tizen::Net::Sockets::Socket&) + 0x58 (0xb261ff1c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cf1c
End of Call Stack
