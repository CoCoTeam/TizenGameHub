...
PID: 17323
Date: 2014-04-29 23:19:07(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 17323, uid 5000)

Register Information
r0   = 0x0058a718, r1   = 0x005f2a28
r2   = 0xbe9ec85c, r3   = 0x00000000
r4   = 0xb263d938, r5   = 0xb263d996
r6   = 0x00385c68, r7   = 0x005aa290
r8   = 0xb25b7e78, r9   = 0x005c4050
r10  = 0x0000002f, fp   = 0xbe9ec898
ip   = 0x00689dc0, sp   = 0xbe9ec7d0
lr   = 0xb4244e9d, pc   = 0xb2658350
cpsr = 0x60000010
...
Callstack Information (PID:17323)
Call Stack Count: 28
 0: FormGameMulti::shuffleCard(Tizen::Base::String) + 0xcc (0xb2658350) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x11350
 1: FormGameMulti::onMatchStart(Tizen::Base::String) + 0x8c (0xb26596b4) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x126b4
 2: non-virtual thunk to FormGameMulti::onMatchStart(Tizen::Base::String) + 0x24 (0xb2659738) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x12738
