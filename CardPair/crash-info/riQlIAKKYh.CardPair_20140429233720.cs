...
PID: 18076
Date: 2014-04-29 23:37:20(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 18076, uid 5000)

Register Information
r0   = 0xbe9ec8a0, r1   = 0x00000000
r2   = 0x00000000, r3   = 0xb4430940
r4   = 0xb263d938, r5   = 0xb263d996
r6   = 0x0032f440, r7   = 0x0019fe70
r8   = 0xb25b7e78, r9   = 0x005be988
r10  = 0x00000033, fp   = 0xbe9ec8f8
ip   = 0xb4431214, sp   = 0xbe9ec7a0
lr   = 0xb4243d89, pc   = 0xb2659860
cpsr = 0x80000010
...
b0df0000 b0df5000 r-xp /usr/lib/libhaptic-module.so
b2317000 b2328000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b2416000 b2418000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
...
Callstack Information (PID:18076)
Call Stack Count: 27
 0: FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x138 (0xb2659860) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x12860
 1: non-virtual thunk to FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x24 (0xb2659cb8) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x12cb8
 2: GHTurnbasedMatchController::ReceiveData(ListenerType::Type, Tizen::Base::String) + 0x1d8 (0xb2622140) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1e140
 3: GHSocket::ReceiveData() + 0x494 (0xb26213f4) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1d3f4
 4: GHSocket::OnSocketReadyToReceive(Tizen::Net::Sockets::Socket&) + 0x58 (0xb2620f38) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cf38
End of Call Stack
