...
PID: 874
Date: 2014-04-30 23:38:54(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 874, uid 5000)

Register Information
r0   = 0xbe9ec6c0, r1   = 0x00000000
r2   = 0x00000000, r3   = 0x00647600
r4   = 0xbe9ec6c0, r5   = 0x08ea98f7
r6   = 0x004ba97c, r7   = 0x001fa5a0
r8   = 0xb25b6e78, r9   = 0x001c46e8
r10  = 0x0000003c, fp   = 0xbe9ec8f8
ip   = 0x0051d820, sp   = 0xbe9ec6b8
lr   = 0xb4244d7f, pc   = 0xb38913ec
cpsr = 0x60000030
...
Callstack Information (PID:874)
Call Stack Count: 29
 0: (0xb38913ec) [/usr/lib/osp/libosp-uifw.so] + 0x4a83ec
 1: Tizen::Ui::Controls::Label::SetText(Tizen::Base::String const&) + 0x18 (0xb375c115) [/usr/lib/osp/libosp-uifw.so] + 0x373115
 2: FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x794 (0xb26595b0) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x135b0
 3: non-virtual thunk to FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x24 (0xb26596ac) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x136ac
 4: GHTurnbasedMatchController::ReceiveData(ListenerType::Type, Tizen::Base::String) + 0x1d8 (0xb2621124) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1e124
 5: GHSocket::ReceiveData() + 0x494 (0xb26203d8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1d3d8
 6: GHSocket::OnSocketReadyToReceive(Tizen::Net::Sockets::Socket&) + 0x58 (0xb261ff1c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cf1c
End of Call Stack
