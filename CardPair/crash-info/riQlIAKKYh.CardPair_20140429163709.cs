...
PID: 12614
Date: 2014-04-29 16:37:09(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 12614, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00003146
r2   = 0x00000006, r3   = 0x00003146
r4   = 0x00000006, r5   = 0xb6beebe4
r6   = 0xb6bee000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x00616988
r10  = 0xb69ff000, fp   = 0xbe9ecc00
ip   = 0xb69ff4c0, sp   = 0xbe9ec640
lr   = 0xb6af555c, pc   = 0xb6af1760
cpsr = 0x20000010
...
000dc000 009d7000 rw-p [heap]
b2244000 b2246000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b2318000 b2329000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b2414000 b2419000 r-xp /usr/lib/libhaptic-module.so
b2425000 b242a000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b245f000 b2462000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b246a000 b246b000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b2473000 b247d000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b24a9000 b24bd000 r-xp /usr/lib/libnetwork.so.0.0.0
b24c6000 b24da000 r-xp /usr/lib/libwifi-direct.so.0.0
b24e2000 b24ea000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b24eb000 b24f4000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b24fc000 b25c1000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b25cf000 b25e9000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b25f3000 b25fc000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b2605000 b2645000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
b2648000 b2663000 r-xp /opt/usr/apps/riQlIAKKYh/bin/CardPair.exe
...
Callstack Information (PID:12614)
Call Stack Count: 29
 0: gsignal + 0x3c (0xb6af1760) [/lib/libc.so.6] + 0x2a760
 1: abort + 0x1ac (0xb6af555c) [/lib/libc.so.6] + 0x2e55c
 2: __assert_fail + 0x10c (0xb6aea63c) [/lib/libc.so.6] + 0x2363c
 3: SysAssertfInternal + 0x82 (0xb4246cef) [/usr/lib/osp/libosp-appfw.so] + 0x132cef
 4: Tizen::Net::Sockets::Socket::Close() + 0x62 (0xb25745bb) [/usr/lib/osp/libosp-net.so.1] + 0x785bb
 5: GHSocket::OnClose() + 0xf4 (0xb2621dd0) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cdd0
 6: GHSocket::OnSocketClosed(Tizen::Net::Sockets::Socket&, Tizen::Net::Sockets::NetSocketClosedReason) + 0xa4 (0xb2621c90) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cc90
 7: (0xb258673d) [/usr/lib/osp/libosp-net.so.1] + 0x8a73d
...
11: Tizen::Net::Sockets::_SocketImpl::OnGioEventCallback(_GIOChannel*, GIOCondition, void*) + 0x588 (0xb2577e71) [/usr/lib/osp/libosp-net.so.1] + 0x7be71
...
23: OspMain + 0x1ac (0xb26530e4) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xb0e4
