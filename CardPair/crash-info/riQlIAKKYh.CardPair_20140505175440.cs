...
PID: 30954
Date: 2014-05-05 17:54:40(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 30954, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x000078ea
r2   = 0x00000006, r3   = 0x000078ea
r4   = 0x00000006, r5   = 0xb6beebe4
r6   = 0xb6bee000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x0056be40
r10  = 0xb69ff000, fp   = 0xbe9ec8f8
ip   = 0xb69ff4c0, sp   = 0xbe9ec150
...
Callstack Information (PID:30954)
Call Stack Count: 32
 ...
 4: Tizen::Ui::Controls::Label::SetText(Tizen::Base::String const&) + 0x30 (0xb375c12d) [/usr/lib/osp/libosp-uifw.so] + 0x37312d
 5: FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x254 (0xb2659374) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x13374
 6: non-virtual thunk to FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x24 (0xb26599b8) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x139b8
