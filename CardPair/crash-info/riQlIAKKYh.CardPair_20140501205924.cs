...
PID: 3094
Date: 2014-05-01 20:59:24(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 3094, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00708e10
r2   = 0x00000001, r3   = 0x00000000
r4   = 0xb2641918, r5   = 0xb2641976
r6   = 0x00134868, r7   = 0x006e5bf8
r8   = 0xb25bbe78, r9   = 0x00131858
r10  = 0x00000034, fp   = 0xbec818f8
ip   = 0x00000000, sp   = 0xbec81790
...
000dc000 009f7000 rw-p [heap]
b209e000 b20a3000 r-xp /usr/lib/libhaptic-module.so
b242b000 b242d000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
...
Callstack Information (PID:3094)
Call Stack Count: 27
 0: FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x1b0 (0xb265d8d8) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x128d8
 1: non-virtual thunk to FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x24 (0xb265dd4c) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x12d4c
