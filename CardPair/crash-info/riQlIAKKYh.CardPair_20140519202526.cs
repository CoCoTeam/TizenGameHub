...
PID: 28430
Date: 2014-05-19 20:25:26(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 28430, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00006f0e
r2   = 0x00000006, r3   = 0x00006f0e
r4   = 0x00000006, r5   = 0xb6c91be4
r6   = 0xb6c91000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x00000002
r10  = 0xb6aa2000, fp   = 0xbea01328
ip   = 0xb6aa24c0, sp   = 0xbea00be8
...
Callstack Information (PID:28430)
Call Stack Count: 8
 ...
 4: _int_malloc + 0x9e0 (0xb6bd4b74) [/lib/libc.so.6] + 0x6ab74
 5: __libc_malloc + 0x7c (0xb6bd6dd0) [/lib/libc.so.6] + 0x6cdd0
 6: operator new(unsigned int, std::nothrow_t const&) + 0x14 (0xb4ce1249) [/usr/lib/libstdc++.so.6] + 0x87249
 7: operator new[](unsigned int, std::nothrow_t const&) + 0x6 (0xb4ce12af) [/usr/lib/libstdc++.so.6] + 0x872af
End of Call Stack
