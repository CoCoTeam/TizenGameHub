...
PID: 18715
Date: 2014-05-08 13:53:02(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 18715, uid 5000)

Register Information
r0   = 0x001542f4, r1   = 0xb266ba00
r2   = 0x001542f4, r3   = 0xb261f614
r4   = 0x0014fbd0, r5   = 0x00153120
r6   = 0xbe9ec91c, r7   = 0xbe9ec7ac
r8   = 0xbe9ec81c, r9   = 0x0014fbd4
r10  = 0x00000000, fp   = 0xbe9ec388
ip   = 0xb266b924, sp   = 0xbe9ec2f0
lr   = 0xb261d1c0, pc   = 0xb262141c
cpsr = 0x60000010
...
b2454000 b2457000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b245f000 b2460000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b2468000 b2472000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b249e000 b24b2000 r-xp /usr/lib/libnetwork.so.0.0.0
b24bb000 b24cf000 r-xp /usr/lib/libwifi-direct.so.0.0
b24d7000 b24df000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b24e0000 b24e9000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b24f1000 b25b6000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b25c4000 b25de000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b25e8000 b25f1000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b25fa000 b263b000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
...
Callstack Information (PID:18715)
Call Stack Count: 42
 0: Tizen::Ui::IProgressPopupEventListener::IProgressPopupEventListener() + 0x24 (0xb262141c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x2741c
 1: GHPlayerController::GHPlayerController() + 0x54 (0xb261d1c0) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x231c0
 2: FormMain::FormMain() + 0xc4 (0xb265ad70) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x14d70
 3: CardPairFormFactory::CreateFormN(Tizen::Base::String const&, Tizen::Base::String const&) + 0x130 (0xb2651870) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xb870
End of Call Stack
