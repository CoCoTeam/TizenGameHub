...
PID: 29763
Date: 2014-05-14 16:24:38(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 29763, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000000
r2   = 0xbea01b64, r3   = 0x00000014
r4   = 0xfffedb9c, r5   = 0xb261506c
r6   = 0x00643dd0, r7   = 0x0073b2e0
r8   = 0xb2614e78, r9   = 0x006a8d40
r10  = 0x0000003b, fp   = 0xbea01c18
ip   = 0x0042bbd0, sp   = 0xbea01a20
lr   = 0xb42e96d1, pc   = 0xb26a617c
cpsr = 0x60000010
...
000dc000 00aa1000 rw-p [heap]
b0e4d000 b0e52000 r-xp /usr/lib/libhaptic-module.so
b2374000 b2385000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b2473000 b2475000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b2481000 b2486000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b24bb000 b24be000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b24c6000 b24c7000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b24cf000 b24d9000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b2505000 b2519000 r-xp /usr/lib/libnetwork.so.0.0.0
b2522000 b2536000 r-xp /usr/lib/libwifi-direct.so.0.0
b253e000 b2546000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b2547000 b2550000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b2558000 b261d000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b262b000 b2648000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b2651000 b266b000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b2675000 b267e000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b2687000 b26d7000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
...
Call Stack Count: 24
 0: GHSocket::ReceiveData() + 0x2a0 (0xb26a617c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1f17c
 1: GHSocket::OnSocketReadyToReceive(Tizen::Net::Sockets::Socket&) + 0x58 (0xb26a5eb4) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1eeb4
 2: (0xb25e26d9) [/usr/lib/osp/libosp-net.so.1] + 0x8a6d9
 ...
 6: Tizen::Net::Sockets::_SocketImpl::OnGioEventCallback(_GIOChannel*, GIOCondition, void*) + 0x3d6 (0xb25d3cbf) [/usr/lib/osp/libosp-net.so.1] + 0x7bcbf
 7: g_io_unix_dispatch + 0x2a (0xb6d61783) [/usr/lib/libglib-2.0.so.0] + 0x64783
 8: g_main_context_dispatch + 0xce (0xb6d35a37) [/usr/lib/libglib-2.0.so.0] + 0x38a37
 9: _ecore_glib_select + 0x3ae (0xb6953337) [/usr/lib/libecore.so.1] + 0xf337
10: _ecore_main_select + 0x294 (0xb694e8b9) [/usr/lib/libecore.so.1] + 0xa8b9
11: _ecore_main_loop_iterate_internal + 0x2de (0xb694f2f3) [/usr/lib/libecore.so.1] + 0xb2f3
12: ecore_main_loop_begin + 0x30 (0xb694f5cd) [/usr/lib/libecore.so.1] + 0xb5cd
13: elm_run + 0x6 (0xb6a1819f) [/usr/lib/libelementary.so.1] + 0xa819f
14: appcore_efl_main + 0x2d4 (0xb6f817d5) [/usr/lib/libappcore-efl.so.1] + 0x27d5
15: app_efl_main + 0xc6 (0xb3f5907f) [/usr/lib/libcapi-appfw-application.so.0] + 0x807f
16: Tizen::App::_AppImpl::Execute(Tizen::App::_IAppImpl*) + 0xe6 (0xb42a48b3) [/usr/lib/osp/libosp-appfw.so] + 0xed8b3
17: Tizen::App::UiApp::Execute(Tizen::App::UiApp* (*)(), Tizen::Base::Collection::IList const*) + 0x64 (0xb3b37231) [/usr/lib/osp/libosp-uifw.so] + 0x6ab231
18: OspMain + 0x1ac (0xb26f06bc) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xe6bc
19: main + 0x194 (0xb4184f21) [/opt/apps/riQlIAKKYh/bin/CardPair] + 0xf21
...
22: __libc_start_main + 0x114 (0xb6b7f6e8) [/lib/libc.so.6] + 0x156e8
