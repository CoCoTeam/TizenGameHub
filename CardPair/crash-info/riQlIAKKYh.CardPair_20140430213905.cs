...
PID: 29425
Date: 2014-04-30 21:39:05(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 29425, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x000072f1
r2   = 0x00000006, r3   = 0x000072f1
r4   = 0x00000006, r5   = 0xb6beebe4
r6   = 0xb6bee000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x00738048
r10  = 0xb69ff000, fp   = 0xbe9ec720
ip   = 0xb69ff4c0, sp   = 0xbe9ec138
...
000dc000 00b82000 rw-p [heap]
b2242000 b2244000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b2316000 b2327000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b2412000 b2417000 r-xp /usr/lib/libhaptic-module.so
b2423000 b2428000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b245d000 b2460000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b2468000 b2469000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b2471000 b247b000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b24a7000 b24bb000 r-xp /usr/lib/libnetwork.so.0.0.0
b24c4000 b24d8000 r-xp /usr/lib/libwifi-direct.so.0.0
b24e0000 b24e8000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b24e9000 b24f2000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b24fa000 b25bf000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b25cd000 b25e7000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b25f1000 b25fa000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b2603000 b2643000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
b2646000 b2662000 r-xp /opt/usr/apps/riQlIAKKYh/bin/CardPair.exe
...
Callstack Information (PID:29425)
Call Stack Count: 33
 ...
 4: Tizen::Ui::Controls::Button::SetText(Tizen::Base::String const&) + 0x30 (0xb374d6cd) [/usr/lib/osp/libosp-uifw.so] + 0x3646cd
 5: FormGame::setCardVisible(int, bool) + 0x60 (0xb2655318) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xf318
 6: FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x2d4 (0xb2658d88) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x12d88
 7: non-virtual thunk to FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x24 (0xb26592a8) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x132a8
 8: GHTurnbasedMatchController::ReceiveData(ListenerType::Type, Tizen::Base::String) + 0x1d8 (0xb2621124) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1e124
 9: GHSocket::ReceiveData() + 0x494 (0xb26203d8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1d3d8
10: GHSocket::OnSocketReadyToReceive(Tizen::Net::Sockets::Socket&) + 0x58 (0xb261ff1c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cf1c
End of Call Stack
