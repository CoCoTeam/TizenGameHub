...
PID: 15376
Date: 2014-05-13 18:22:02(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 15376, uid 5000)

Register Information
r0   = 0xa00009c5, r1   = 0x00000000
r2   = 0x00000000, r3   = 0x05d48860
r4   = 0xb265ecb1, r5   = 0xb26cf742
r6   = 0xfffed0e1, r7   = 0xfffc3b94
r8   = 0x00000002, r9   = 0xb25ef1ec
r10  = 0x002eec58, fp   = 0xbea016c8
ip   = 0x00000078, sp   = 0xbea01688
lr   = 0xb26618e1, pc   = 0xb26a7444
cpsr = 0x88000010
...
Callstack Information (PID:15376)
Call Stack Count: 27
 0: GHController::getIntByKey(Tizen::Web::Json::JsonObject*, Tizen::Base::String const*) + 0x58 (0xb26a7444) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1e444
 1: GHAttackhelperController::OnTransactionReadyToRead(Tizen::Base::String, Tizen::Base::String, Tizen::Web::Json::IJsonValue*) + 0x1078 (0xb26ca054) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x41054
 2: GHController::OnTransactionReadyToRead(Tizen::Net::Http::HttpSession&, Tizen::Net::Http::HttpTransaction&, int) + 0x30c (0xb26a6c1c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1dc1c
 3: (0xb25a328f) [/usr/lib/osp/libosp-net.so.1] + 0x4928f
 ...
 7: (0xb25a38ff) [/usr/lib/osp/libosp-net.so.1] + 0x498ff
 8: (0xb25a2a1f) [/usr/lib/osp/libosp-net.so.1] + 0x48a1f
 9: Tizen::Net::Http::_HttpTransactionImpl::OnSocketReceivedEvent(_GIOChannel*, GIOCondition, void*) + 0x80 (0xb25a8075) [/usr/lib/osp/libosp-net.so.1] + 0x4e075
