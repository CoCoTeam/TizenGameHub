...
PID: 4965
Date: 2014-04-29 22:41:10(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 4965, uid 5000)

Register Information
r0   = 0x00000044, r1   = 0xa0000a2a
r2   = 0x00000002, r3   = 0xa0000c2f
r4   = 0x00000000, r5   = 0x00000044
r6   = 0x00404600, r7   = 0x006148c0
r8   = 0xb25b2e78, r9   = 0x001f57f0
r10  = 0x000576d2, fp   = 0xbe9ec960
ip   = 0xb25c84fc, sp   = 0xbe9ec8c8
lr   = 0xb256e59b, pc   = 0xb256ff80
cpsr = 0x60000030
...
Call Stack Count: 28
 0: Tizen::Net::Sockets::_SocketImpl::Close() + 0xb (0xb256ff80) [/usr/lib/osp/libosp-net.so.1] + 0x79f80
 1: Tizen::Net::Sockets::Socket::Close() + 0x42 (0xb256e59b) [/usr/lib/osp/libosp-net.so.1] + 0x7859b
 2: GHSocket::OnClose() + 0xf4 (0xb261bce8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cce8
 3: GHTurnbasedMatchController::ReceiveData(ListenerType::Type, Tizen::Base::String) + 0x128 (0xb261cfa8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1dfa8
 4: GHSocket::ReceiveData() + 0x494 (0xb261c30c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1d30c
 5: GHSocket::OnSocketReadyToReceive(Tizen::Net::Sockets::Socket&) + 0x58 (0xb261be50) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1ce50
 6: (0xb25806d9) [/usr/lib/osp/libosp-net.so.1] + 0x8a6d9
 7: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2c0 (0xb426a1c5) [/usr/lib/osp/libosp-appfw.so] + 0x1561c5
 8: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb426a3fb) [/usr/lib/osp/libosp-appfw.so] + 0x1563fb
 9: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb426a4ed) [/usr/lib/osp/libosp-appfw.so] + 0x1564ed
10: Tizen::Net::Sockets::_SocketImpl::OnGioEventCallback(_GIOChannel*, GIOCondition, void*) + 0x3d6 (0xb2571cbf) [/usr/lib/osp/libosp-net.so.1] + 0x7bcbf
11: g_io_unix_dispatch + 0x2a (0xb6cbe783) [/usr/lib/libglib-2.0.so.0] + 0x64783
12: g_main_context_dispatch + 0xce (0xb6c92a37) [/usr/lib/libglib-2.0.so.0] + 0x38a37
13: _ecore_glib_select + 0x3ae (0xb68b0337) [/usr/lib/libecore.so.1] + 0xf337
14: _ecore_main_select + 0x294 (0xb68ab8b9) [/usr/lib/libecore.so.1] + 0xa8b9
15: _ecore_main_loop_iterate_internal + 0x2de (0xb68ac2f3) [/usr/lib/libecore.so.1] + 0xb2f3
16: ecore_main_loop_begin + 0x30 (0xb68ac5cd) [/usr/lib/libecore.so.1] + 0xb5cd
17: elm_run + 0x6 (0xb697519f) [/usr/lib/libelementary.so.1] + 0xa819f
18: appcore_efl_main + 0x2d4 (0xb6ede7d5) [/usr/lib/libappcore-efl.so.1] + 0x27d5
19: app_efl_main + 0xc6 (0xb3eb607f) [/usr/lib/libcapi-appfw-application.so.0] + 0x807f
20: Tizen::App::_AppImpl::Execute(Tizen::App::_IAppImpl*) + 0xe6 (0xb42018b3) [/usr/lib/osp/libosp-appfw.so] + 0xed8b3
21: Tizen::App::UiApp::Execute(Tizen::App::UiApp* (*)(), Tizen::Base::Collection::IList const*) + 0x64 (0xb3a94231) [/usr/lib/osp/libosp-uifw.so] + 0x6ab231
22: OspMain + 0x1ac (0xb265407c) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xb07c
23: main + 0x194 (0xb40e1f21) [/opt/apps/riQlIAKKYh/bin/CardPair] + 0xf21
...
26: __libc_start_main + 0x114 (0xb6adc6e8) [/lib/libc.so.6] + 0x156e8
