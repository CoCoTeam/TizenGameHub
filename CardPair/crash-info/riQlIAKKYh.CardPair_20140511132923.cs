...
PID: 5946
Date: 2014-05-11 13:29:23(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 5946, uid 5000)

Register Information
r0   = 0x00162110, r1   = 0x00000a6c
r2   = 0xcbc06800, r3   = 0xcbc06800
r4   = 0xb268b179, r5   = 0xb268b0fa
r6   = 0xfffeef91, r7   = 0xfffc3b94
r8   = 0x00000002, r9   = 0xb25dd1ec
r10  = 0x00162110, fp   = 0xbe830d50
ip   = 0x000033a8, sp   = 0xbe830980
lr   = 0xb2685e70, pc   = 0xb2686380
cpsr = 0x20000010
...
b0e3d000 b0e42000 r-xp /usr/lib/libhaptic-module.so
b2364000 b2375000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b2463000 b2465000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b2471000 b2476000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
...
b261b000 b2635000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b263f000 b2648000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b2651000 b2693000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
...
Callstack Information (PID:5946)
Call Stack Count: 26
 0: GHAttackhelperController::OnTransactionReadyToRead(Tizen::Base::String, Tizen::Base::String, Tizen::Web::Json::IJsonValue*) + 0x4ec (0xb2686380) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x35380
 1: GHController::OnTransactionReadyToRead(Tizen::Net::Http::HttpSession&, Tizen::Net::Http::HttpTransaction&, int) + 0x30c (0xb266b290) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1a290
 2: (0xb259128f) [/usr/lib/osp/libosp-net.so.1] + 0x4928f
 ...
 6: (0xb25918ff) [/usr/lib/osp/libosp-net.so.1] + 0x498ff
 7: (0xb2590a1f) [/usr/lib/osp/libosp-net.so.1] + 0x48a1f
 8: Tizen::Net::Http::_HttpTransactionImpl::OnSocketReceivedEvent(_GIOChannel*, GIOCondition, void*) + 0x80 (0xb2596075) [/usr/lib/osp/libosp-net.so.1] + 0x4e075
