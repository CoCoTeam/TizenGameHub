...
PID: 17956
Date: 2014-05-11 21:57:38(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 17956, uid 5000)

Register Information
r0   = 0xbe8308b8, r1   = 0x00000000
r2   = 0xb447c330, r3   = 0xb4489940
r4   = 0xffff0632, r5   = 0xb2689ffa
r6   = 0xfffee3b1, r7   = 0xfffc3b94
r8   = 0x00000002, r9   = 0xb25b01ec
r10  = 0x0034c1b8, fp   = 0xbe830908
ip   = 0xb448a214, sp   = 0xbe830700
lr   = 0xb429cd89, pc   = 0xb26841a0
cpsr = 0x80000010
...
000dc000 00439000 rw-p [heap]
b0e10000 b0e15000 r-xp /usr/lib/libhaptic-module.so
b2337000 b2348000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b2436000 b2438000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b2444000 b2449000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b247e000 b2481000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b2489000 b248a000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b2492000 b249c000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b24c8000 b24dc000 r-xp /usr/lib/libnetwork.so.0.0.0
b24e5000 b24f9000 r-xp /usr/lib/libwifi-direct.so.0.0
b2501000 b2509000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b250a000 b2513000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b251b000 b25e0000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b25ee000 b260b000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b2614000 b262e000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b2638000 b2641000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b264a000 b2692000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
...
Callstack Information (PID:17956)
Call Stack Count: 27
 0: GHAttackhelperController::loadDataReceievedPopup(Tizen::Base::Collection::ArrayList*) + 0x114 (0xb26841a0) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x3a1a0
 1: GHAttackhelperController::OnTransactionReadyToRead(Tizen::Base::String, Tizen::Base::String, Tizen::Web::Json::IJsonValue*) + 0xcb4 (0xb26853f4) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x3b3f4
 2: GHController::OnTransactionReadyToRead(Tizen::Net::Http::HttpSession&, Tizen::Net::Http::HttpTransaction&, int) + 0x30c (0xb26669f4) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1c9f4
 3: (0xb256428f) [/usr/lib/osp/libosp-net.so.1] + 0x4928f
 4: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2c0 (0xb42c31c5) [/usr/lib/osp/libosp-appfw.so] + 0x1561c5
 5: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb42c33fb) [/usr/lib/osp/libosp-appfw.so] + 0x1563fb
 6: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb42c34ed) [/usr/lib/osp/libosp-appfw.so] + 0x1564ed
 7: (0xb25648ff) [/usr/lib/osp/libosp-net.so.1] + 0x498ff
 8: (0xb2563a1f) [/usr/lib/osp/libosp-net.so.1] + 0x48a1f
 9: Tizen::Net::Http::_HttpTransactionImpl::OnSocketReceivedEvent(_GIOChannel*, GIOCondition, void*) + 0x80 (0xb2569075) [/usr/lib/osp/libosp-net.so.1] + 0x4e075
10: g_io_unix_dispatch + 0x2a (0xb6d17783) [/usr/lib/libglib-2.0.so.0] + 0x64783
11: g_main_context_dispatch + 0xce (0xb6ceba37) [/usr/lib/libglib-2.0.so.0] + 0x38a37
12: _ecore_glib_select + 0x3ae (0xb6909337) [/usr/lib/libecore.so.1] + 0xf337
13: _ecore_main_select + 0x294 (0xb69048b9) [/usr/lib/libecore.so.1] + 0xa8b9
14: _ecore_main_loop_iterate_internal + 0x2de (0xb69052f3) [/usr/lib/libecore.so.1] + 0xb2f3
15: ecore_main_loop_begin + 0x30 (0xb69055cd) [/usr/lib/libecore.so.1] + 0xb5cd
16: elm_run + 0x6 (0xb69ce19f) [/usr/lib/libelementary.so.1] + 0xa819f
17: appcore_efl_main + 0x2d4 (0xb6f377d5) [/usr/lib/libappcore-efl.so.1] + 0x27d5
18: app_efl_main + 0xc6 (0xb3f0f07f) [/usr/lib/libcapi-appfw-application.so.0] + 0x807f
19: Tizen::App::_AppImpl::Execute(Tizen::App::_IAppImpl*) + 0xe6 (0xb425a8b3) [/usr/lib/osp/libosp-appfw.so] + 0xed8b3
20: Tizen::App::UiApp::Execute(Tizen::App::UiApp* (*)(), Tizen::Base::Collection::IList const*) + 0x64 (0xb3aed231) [/usr/lib/osp/libosp-uifw.so] + 0x6ab231
21: OspMain + 0x1ac (0xb26a96e4) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xc6e4
22: main + 0x194 (0xb413af21) [/opt/apps/riQlIAKKYh/bin/CardPair] + 0xf21
...
25: __libc_start_main + 0x114 (0xb6b356e8) [/lib/libc.so.6] + 0x156e8
