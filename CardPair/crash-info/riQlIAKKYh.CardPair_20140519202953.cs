...
PID: 29079
Date: 2014-05-19 20:29:53(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 29079, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00007197
r2   = 0x00000006, r3   = 0x00007197
r4   = 0x00000006, r5   = 0xb6c91be4
r6   = 0xb6c91000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x00000002
r10  = 0xb6aa2000, fp   = 0xbea02488
ip   = 0xb6aa24c0, sp   = 0xbea01d48
...
Callstack Information (PID:29079)
Call Stack Count: 28
 0: gsignal + 0x3c (0xb6b94760) [/lib/libc.so.6] + 0x2a760
 1: abort + 0x1ac (0xb6b9855c) [/lib/libc.so.6] + 0x2e55c
 2: __libc_message + 0x2cc (0xb6bc8088) [/lib/libc.so.6] + 0x5e088
 3: malloc_printerr + 0xa8 (0xb6bd1f60) [/lib/libc.so.6] + 0x67f60
 4: cfree + 0x98 (0xb6bd7500) [/lib/libc.so.6] + 0x6d500
 5: evas_common_tilebuf_free_render_rects + 0x18 (0xb67cafbd) [/usr/lib/libevas.so.1] + 0x8ffbd
 6: eng_output_redraws_next_update_get + 0x154 (0xb266d699) [/usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so] + 0x2699
 7: evas_render_updates_internal + 0x9e4 (0xb679699d) [/usr/lib/libevas.so.1] + 0x5b99d
 8: evas_render_updates + 0x2c (0xb6797fb1) [/usr/lib/libevas.so.1] + 0x5cfb1
 9: _ecore_evas_x_render + 0x6c (0xb66de469) [/usr/lib/libecore_evas.so.1] + 0x11469
10: ecore_evas_manual_render + 0x36 (0xb66da51b) [/usr/lib/libecore_evas.so.1] + 0xd51b
11: Tizen::Ui::Animations::_EflLayer::Flush() + 0x5e (0xb36e32af) [/usr/lib/osp/libosp-uifw.so] + 0x2572af
12: Tizen::Ui::Animations::_DisplayManager::Flush() + 0x30 (0xb36bea11) [/usr/lib/osp/libosp-uifw.so] + 0x232a11
13: (0xb36e34b7) [/usr/lib/osp/libosp-uifw.so] + 0x2574b7
14: _ecore_idle_enterer_call + 0x48 (0xb694db85) [/usr/lib/libecore.so.1] + 0x9b85
15: _ecore_main_loop_iterate_internal + 0x216 (0xb694f22b) [/usr/lib/libecore.so.1] + 0xb22b
...
22: OspMain + 0x1ac (0xb26ef04c) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xf04c
