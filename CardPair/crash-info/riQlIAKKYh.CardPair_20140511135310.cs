...
PID: 7343
Date: 2014-05-11 13:53:10(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 7343, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00001caf
r2   = 0x00000006, r3   = 0x00001caf
r4   = 0x00000006, r5   = 0xb6c47be4
r6   = 0xb6c47000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x00000002
r10  = 0xb6a58000, fp   = 0xbe8303e0
ip   = 0xb6a584c0, sp   = 0xbe82fca0
lr   = 0xb6b4e55c, pc   = 0xb6b4a760
cpsr = 0x20000010
...
b0e3b000 b0e40000 r-xp /usr/lib/libhaptic-module.so
b2362000 b2373000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b2461000 b2463000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b246f000 b2474000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b24a9000 b24ac000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b24b4000 b24b5000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b24bd000 b24c7000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b24f3000 b2507000 r-xp /usr/lib/libnetwork.so.0.0.0
b2510000 b2524000 r-xp /usr/lib/libwifi-direct.so.0.0
b252c000 b2534000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b2535000 b253e000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b2546000 b260b000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b2619000 b2633000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b263d000 b2646000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b264f000 b2692000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
...
Callstack Information (PID:7343)
Call Stack Count: 46
 0: gsignal + 0x3c (0xb6b4a760) [/lib/libc.so.6] + 0x2a760
 1: abort + 0x1ac (0xb6b4e55c) [/lib/libc.so.6] + 0x2e55c
 2: __libc_message + 0x2cc (0xb6b7e088) [/lib/libc.so.6] + 0x5e088
 3: malloc_printerr + 0xa8 (0xb6b87f60) [/lib/libc.so.6] + 0x67f60
 4: malloc_consolidate + 0x25c (0xb6b882bc) [/lib/libc.so.6] + 0x682bc
 5: _int_malloc + 0x7bc (0xb6b8a950) [/lib/libc.so.6] + 0x6a950
 6: __libc_malloc + 0x7c (0xb6b8cdd0) [/lib/libc.so.6] + 0x6cdd0
 7: _XTextListToTextProperty + 0x82 (0xb6e5a3d7) [/usr/lib/libX11.so.6] + 0x3a3d7
 8: _Xutf8TextListToTextProperty + 0x2c (0xb6e5a745) [/usr/lib/libX11.so.6] + 0x3a745
 9: Xutf8TextListToTextProperty + 0x28 (0xb6e5f2a1) [/usr/lib/libX11.so.6] + 0x3f2a1
10: ecore_x_icccm_icon_name_set + 0x30 (0xb68e1ae9) [/usr/lib/libecore_x.so.1] + 0x20ae9
11: _elm_win_xwin_update + 0x5c (0xb6a0dbc9) [/usr/lib/libelementary.so.1] + 0xe7bc9
12: elm_win_alpha_set + 0x88 (0xb6a0f101) [/usr/lib/libelementary.so.1] + 0xe9101
13: Tizen::Ui::Animations::_EflLayer::SetOpacity(float) + 0x110 (0xb3699bc1) [/usr/lib/osp/libosp-uifw.so] + 0x257bc1
14: Tizen::Ui::_Window::CreateLayer() + 0xa2 (0xb37042ab) [/usr/lib/osp/libosp-uifw.so] + 0x2c22ab
15: Tizen::Ui::_Window::CreateRootVisualElement(Tizen::Ui::_WindowType) + 0x1e (0xb3704cc3) [/usr/lib/osp/libosp-uifw.so] + 0x2c2cc3
16: Tizen::Ui::Controls::_Popup::CreatePopupN() + 0x24 (0xb38758e5) [/usr/lib/osp/libosp-uifw.so] + 0x4338e5
17: (0xb38ef2b3) [/usr/lib/osp/libosp-uifw.so] + 0x4ad2b3
18: Tizen::Ui::Controls::Popup::Construct(bool, Tizen::Graphics::Dimension const&) + 0x46 (0xb37bd483) [/usr/lib/osp/libosp-uifw.so] + 0x37b483
19: GHAttackhelperController::dataReceievedPopup(Tizen::Base::Collection::ArrayList*) + 0xc4 (0xb2685438) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x36438
20: GHAttackhelperController::OnTransactionReadyToRead(Tizen::Base::String, Tizen::Base::String, Tizen::Web::Json::IJsonValue*) + 0x4c4 (0xb2685dac) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x36dac
21: GHController::OnTransactionReadyToRead(Tizen::Net::Http::HttpSession&, Tizen::Net::Http::HttpTransaction&, int) + 0x30c (0xb266a2fc) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1b2fc
22: (0xb258f28f) [/usr/lib/osp/libosp-net.so.1] + 0x4928f
23: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2c0 (0xb42c31c5) [/usr/lib/osp/libosp-appfw.so] + 0x1561c5
24: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb42c33fb) [/usr/lib/osp/libosp-appfw.so] + 0x1563fb
25: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb42c34ed) [/usr/lib/osp/libosp-appfw.so] + 0x1564ed
26: (0xb258f8ff) [/usr/lib/osp/libosp-net.so.1] + 0x498ff
27: (0xb258ea1f) [/usr/lib/osp/libosp-net.so.1] + 0x48a1f
28: Tizen::Net::Http::_HttpTransactionImpl::OnSocketReceivedEvent(_GIOChannel*, GIOCondition, void*) + 0x80 (0xb2594075) [/usr/lib/osp/libosp-net.so.1] + 0x4e075
29: g_io_unix_dispatch + 0x2a (0xb6d17783) [/usr/lib/libglib-2.0.so.0] + 0x64783
30: g_main_context_dispatch + 0xce (0xb6ceba37) [/usr/lib/libglib-2.0.so.0] + 0x38a37
31: _ecore_glib_select + 0x3ae (0xb6909337) [/usr/lib/libecore.so.1] + 0xf337
32: _ecore_main_select + 0x294 (0xb69048b9) [/usr/lib/libecore.so.1] + 0xa8b9
33: _ecore_main_loop_iterate_internal + 0x2de (0xb69052f3) [/usr/lib/libecore.so.1] + 0xb2f3
34: ecore_main_loop_begin + 0x30 (0xb69055cd) [/usr/lib/libecore.so.1] + 0xb5cd
35: elm_run + 0x6 (0xb69ce19f) [/usr/lib/libelementary.so.1] + 0xa819f
36: appcore_efl_main + 0x2d4 (0xb6f377d5) [/usr/lib/libappcore-efl.so.1] + 0x27d5
37: app_efl_main + 0xc6 (0xb3f0f07f) [/usr/lib/libcapi-appfw-application.so.0] + 0x807f
38: Tizen::App::_AppImpl::Execute(Tizen::App::_IAppImpl*) + 0xe6 (0xb425a8b3) [/usr/lib/osp/libosp-appfw.so] + 0xed8b3
39: Tizen::App::UiApp::Execute(Tizen::App::UiApp* (*)(), Tizen::Base::Collection::IList const*) + 0x64 (0xb3aed231) [/usr/lib/osp/libosp-uifw.so] + 0x6ab231
40: OspMain + 0x1ac (0xb26a924c) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xc24c
41: main + 0x194 (0xb413af21) [/opt/apps/riQlIAKKYh/bin/CardPair] + 0xf21
42: __launchpad_main_loop + 0xe54 (0xb259) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xb259
43: main + 0x486 (0xbcb3) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xbcb3
44: __libc_start_main + 0x114 (0xb6b356e8) [/lib/libc.so.6] + 0x156e8
45: (0xa110) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xa110
End of Call Stack
