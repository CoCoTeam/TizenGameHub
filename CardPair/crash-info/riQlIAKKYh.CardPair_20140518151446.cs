...
PID: 16361
Date: 2014-05-18 15:14:46(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 16361, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00003fe9
r2   = 0x00000006, r3   = 0x00003fe9
r4   = 0x00000006, r5   = 0xb6c91be4
r6   = 0xb6c91000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x003bc368
r10  = 0xb6aa2000, fp   = 0x00000000
ip   = 0xb6aa24c0, sp   = 0xbea01258
lr   = 0xb6b9855c, pc   = 0xb6b94760
cpsr = 0x28000010
...
000dc000 00712000 rw-p [heap]
b0e49000 b0e4e000 r-xp /usr/lib/libhaptic-module.so
b2370000 b2381000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b246f000 b2471000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b247d000 b2482000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b24b7000 b24ba000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b24c2000 b24c3000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b24cb000 b24d5000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b2501000 b2515000 r-xp /usr/lib/libnetwork.so.0.0.0
b251e000 b2532000 r-xp /usr/lib/libwifi-direct.so.0.0
b253a000 b2542000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b2543000 b254c000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b2554000 b2619000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b2627000 b2644000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b264d000 b2667000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b2671000 b267a000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b2683000 b26d6000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
b26e1000 b2705000 r-xp /opt/usr/apps/riQlIAKKYh/bin/CardPair.exe
...
Callstack Information (PID:16361)
Call Stack Count: 38
 0: gsignal + 0x3c (0xb6b94760) [/lib/libc.so.6] + 0x2a760
 1: abort + 0x1ac (0xb6b9855c) [/lib/libc.so.6] + 0x2e55c
 2: __assert_fail + 0x10c (0xb6b8d63c) [/lib/libc.so.6] + 0x2363c
 3: SysAssertfInternal + 0x82 (0xb42e9cef) [/usr/lib/osp/libosp-appfw.so] + 0x132cef
 4: Tizen::Ui::Controls::Form::Construct(unsigned long) + 0x4a (0xb37ff747) [/usr/lib/osp/libosp-uifw.so] + 0x373747
 5: (0xb392d6c7) [/usr/lib/osp/libosp-uifw.so] + 0x4a16c7
 6: Tizen::Ui::_UiBuilderControlMaker::MakeControl(Tizen::Ui::_UiBuilderControl*) + 0x1e (0xb379d213) [/usr/lib/osp/libosp-uifw.so] + 0x311213
 7: Tizen::Ui::_UiBuilder::MakeUI(Tizen::Ui::_UiBuilderControl*) + 0x92 (0xb37968c7) [/usr/lib/osp/libosp-uifw.so] + 0x30a8c7
 8: Tizen::Ui::_UiBuilder::Parse() + 0x566 (0xb3796e4b) [/usr/lib/osp/libosp-uifw.so] + 0x30ae4b
 9: Tizen::Ui::Controls::Form::Construct(Tizen::Base::String const&) + 0x34 (0xb37ff7e1) [/usr/lib/osp/libosp-uifw.so] + 0x3737e1
10: AchievementForm::OnFormBackRequested(Tizen::Ui::Controls::Form&) + 0xac (0xb26b6994) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x33994
11: non-virtual thunk to AchievementForm::OnFormBackRequested(Tizen::Ui::Controls::Form&) + 0x2c (0xb26b6a34) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x33a34
12: Tizen::Ui::Controls::_FormImpl::OnFormBackRequested(Tizen::Ui::Controls::_Form&) + 0x2c (0xb392a04d) [/usr/lib/osp/libosp-uifw.so] + 0x49e04d
13: Tizen::Ui::Controls::_Form::OnKeyReleased(Tizen::Ui::_Control const&, Tizen::Ui::_KeyInfo const&) + 0x5c (0xb3886ba9) [/usr/lib/osp/libosp-uifw.so] + 0x3faba9
14: Tizen::Ui::_ControlImpl::_PropagatedKeyEventListener::OnKeyReleased(Tizen::Ui::_Control const&, Tizen::Ui::_KeyInfo const&) + 0xb2 (0xb375b1f7) [/usr/lib/osp/libosp-uifw.so] + 0x2cf1f7
15: (0xb37bf98b) [/usr/lib/osp/libosp-uifw.so] + 0x33398b
16: (0xb37bfa95) [/usr/lib/osp/libosp-uifw.so] + 0x333a95
17: Tizen::Ui::_UiEvent::ProcessEvent(Tizen::Ui::_Control const&, bool&) + 0x32 (0xb37b4f53) [/usr/lib/osp/libosp-uifw.so] + 0x328f53
18: Tizen::Ui::_UiEventManager::ProcessBubblingEvent(Tizen::Base::Collection::LinkedListT<Tizen::Base::_HandleT<Tizen::Ui::_Control> > const&, Tizen::Ui::_UiEvent const&, bool&) + 0x78 (0xb37b5901) [/usr/lib/osp/libosp-uifw.so] + 0x329901
19: Tizen::Ui::_UiEventManager::ProcessEvent(Tizen::Ui::_UiEvent const&, bool&) + 0x234 (0xb37b5bd5) [/usr/lib/osp/libosp-uifw.so] + 0x329bd5
20: Tizen::Ui::_UiEventManager::Fire(Tizen::Ui::_UiEvent const&) + 0xb0 (0xb37b5cdd) [/usr/lib/osp/libosp-uifw.so] + 0x329cdd
21: Tizen::Ui::_UiEventManager::SendEvent(Tizen::Ui::_UiEvent const&) + 0x6 (0xb37b5d4b) [/usr/lib/osp/libosp-uifw.so] + 0x329d4b
22: (0xb37a53cb) [/usr/lib/osp/libosp-uifw.so] + 0x3193cb
23: (0xb37a78e7) [/usr/lib/osp/libosp-uifw.so] + 0x31b8e7
24: _ecore_event_call + 0x2ac (0xb694bb05) [/usr/lib/libecore.so.1] + 0x7b05
25: _ecore_main_loop_iterate_internal + 0x196 (0xb694f1ab) [/usr/lib/libecore.so.1] + 0xb1ab
26: ecore_main_loop_begin + 0x30 (0xb694f5cd) [/usr/lib/libecore.so.1] + 0xb5cd
27: elm_run + 0x6 (0xb6a1819f) [/usr/lib/libelementary.so.1] + 0xa819f
28: appcore_efl_main + 0x2d4 (0xb6f817d5) [/usr/lib/libappcore-efl.so.1] + 0x27d5
29: app_efl_main + 0xc6 (0xb3f5907f) [/usr/lib/libcapi-appfw-application.so.0] + 0x807f
30: Tizen::App::_AppImpl::Execute(Tizen::App::_IAppImpl*) + 0xe6 (0xb42a48b3) [/usr/lib/osp/libosp-appfw.so] + 0xed8b3
31: Tizen::App::UiApp::Execute(Tizen::App::UiApp* (*)(), Tizen::Base::Collection::IList const*) + 0x64 (0xb3b37231) [/usr/lib/osp/libosp-uifw.so] + 0x6ab231
32: OspMain + 0x1ac (0xb26ef7c0) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xe7c0
33: main + 0x194 (0xb4184f21) [/opt/apps/riQlIAKKYh/bin/CardPair] + 0xf21
34: __launchpad_main_loop + 0xe54 (0xb259) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xb259
35: main + 0x486 (0xbcb3) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xbcb3
36: __libc_start_main + 0x114 (0xb6b7f6e8) [/lib/libc.so.6] + 0x156e8
37: (0xa110) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xa110
End of Call Stack
