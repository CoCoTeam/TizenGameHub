...
PID: 12207
Date: 2014-04-29 16:24:56(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 12207, uid 5000)

Register Information
r0   = 0x00000044, r1   = 0xa0000a2a
r2   = 0x00000002, r3   = 0xa0000c2f
r4   = 0x00000000, r5   = 0x00000044
r6   = 0x001f6620, r7   = 0x00318f48
r8   = 0xb25b8e78, r9   = 0x00629bc8
r10  = 0x000576d2, fp   = 0xbe9ecc00
ip   = 0xb25ce4fc, sp   = 0xbe9ecb68
lr   = 0xb257459b, pc   = 0xb2575f80
cpsr = 0x60000030
...
Callstack Information (PID:12207)
Call Stack Count: 26
 0: Tizen::Net::Sockets::_SocketImpl::Close() + 0xb (0xb2575f80) [/usr/lib/osp/libosp-net.so.1] + 0x79f80
 1: Tizen::Net::Sockets::Socket::Close() + 0x42 (0xb257459b) [/usr/lib/osp/libosp-net.so.1] + 0x7859b
 2: GHSocket::OnClose() + 0xf4 (0xb2621dd0) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cdd0
 3: GHSocket::OnSocketClosed(Tizen::Net::Sockets::Socket&, Tizen::Net::Sockets::NetSocketClosedReason) + 0xa4 (0xb2621c90) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cc90
 4: (0xb258673d) [/usr/lib/osp/libosp-net.so.1] + 0x8a73d
 ...
 8: Tizen::Net::Sockets::_SocketImpl::OnGioEventCallback(_GIOChannel*, GIOCondition, void*) + 0x588 (0xb2577e71) [/usr/lib/osp/libosp-net.so.1] + 0x7be71
...
20: OspMain + 0x1ac (0xb26530e4) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xb0e4
