...
PID: 5460
Date: 2014-04-29 23:32:54(GMT+0900)
...
r6   = 0x003f1ad8, r7   = 0x006369c8
r8   = 0xb25b1e78, r9   = 0x001da7a8
r10  = 0x000576d2, fp   = 0xbe9ecc00
ip   = 0xb25c74fc, sp   = 0xbe9ecb68
lr   = 0xb256d59b, pc   = 0xb256ef80
cpsr = 0x60000030
...
Call Stack Count: 26
 0: Tizen::Net::Sockets::_SocketImpl::Close() + 0xb (0xb256ef80) [/usr/lib/osp/libosp-net.so.1] + 0x79f80
 1: Tizen::Net::Sockets::Socket::Close() + 0x42 (0xb256d59b) [/usr/lib/osp/libosp-net.so.1] + 0x7859b
 2: GHSocket::OnClose() + 0xf4 (0xb261ace8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cce8
 3: GHSocket::OnSocketClosed(Tizen::Net::Sockets::Socket&, Tizen::Net::Sockets::NetSocketClosedReason) + 0xa4 (0xb261aba8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cba8
 4: (0xb257f73d) [/usr/lib/osp/libosp-net.so.1] + 0x8a73d
 ...
 8: Tizen::Net::Sockets::_SocketImpl::OnGioEventCallback(_GIOChannel*, GIOCondition, void*) + 0x588 (0xb2570e71) [/usr/lib/osp/libosp-net.so.1] + 0x7be71
...
20: OspMain + 0x1ac (0xb2653084) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xb084
