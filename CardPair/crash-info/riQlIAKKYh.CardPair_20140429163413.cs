...
PID: 12490
Date: 2014-04-29 16:34:13(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 12490, uid 5000)

Register Information
r0   = 0x00321480, r1   = 0x00000000
r2   = 0xb6bef248, r3   = 0xb4430940
r4   = 0xb263e63b, r5   = 0xb263e6ac
r6   = 0x00590270, r7   = 0x001f63b8
r8   = 0xb25b8e78, r9   = 0x0042ffb8
r10  = 0x0000002f, fp   = 0xbe9ecc00
ip   = 0xb4c5d128, sp   = 0xbe9ecbd0
lr   = 0xb6b3452c, pc   = 0xb2621e20
cpsr = 0x20000010
...
Callstack Information (PID:12490)
Call Stack Count: 24
 0: GHSocket::OnClose() + 0x144 (0xb2621e20) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1ce20
 1: GHSocket::OnSocketClosed(Tizen::Net::Sockets::Socket&, Tizen::Net::Sockets::NetSocketClosedReason) + 0xa4 (0xb2621c90) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cc90
 2: (0xb258673d) [/usr/lib/osp/libosp-net.so.1] + 0x8a73d
 ...
 6: Tizen::Net::Sockets::_SocketImpl::OnGioEventCallback(_GIOChannel*, GIOCondition, void*) + 0x588 (0xb2577e71) [/usr/lib/osp/libosp-net.so.1] + 0x7be71
...
18: OspMain + 0x1ac (0xb26530e4) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xb0e4
