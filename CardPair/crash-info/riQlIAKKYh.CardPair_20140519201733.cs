...
PID: 27977
Date: 2014-05-19 20:17:33(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 27977, uid 5000)

Register Information
r0   = 0x005e62b0, r1   = 0x00000003
r2   = 0x00000000, r3   = 0x00000048
r4   = 0xbea016d0, r5   = 0x005e62b0
r6   = 0xb3deed70, r7   = 0x00631ca8
r8   = 0xb260ae78, r9   = 0x0082d8e8
r10  = 0x0000003a, fp   = 0xbea018f0
ip   = 0x006cfaf0, sp   = 0xbea016c8
lr   = 0xb42e7d7f, pc   = 0xb39343f2
cpsr = 0x68000030
...
000dc000 00c8a000 rw-p [heap]
b246d000 b2472000 r-xp /usr/lib/libhaptic-module.so
b247a000 b247c000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
...
Callstack Information (PID:27977)
Call Stack Count: 29
 0: (0xb39343f2) [/usr/lib/osp/libosp-uifw.so] + 0x4a83f2
 1: Tizen::Ui::Controls::Label::SetText(Tizen::Base::String const&) + 0x18 (0xb37ff115) [/usr/lib/osp/libosp-uifw.so] + 0x373115
 2: FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x254 (0xb26f77a8) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x177a8
 3: non-virtual thunk to FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x24 (0xb26f7cc0) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x17cc0
 4: GHTurnbasedMatchController::ReceiveData(ListenerType::Type, Tizen::Base::String) + 0x1d8 (0xb26a2710) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x25710
 5: GHSocket::ReceiveData() + 0x494 (0xb269e734) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x21734
 6: GHSocket::OnSocketReadyToReceive(Tizen::Net::Sockets::Socket&) + 0x58 (0xb269e278) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x21278
End of Call Stack
