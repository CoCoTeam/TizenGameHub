...
PID: 2289
Date: 2014-04-29 21:42:07(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 2289, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000000
r2   = 0xbe9ecb64, r3   = 0x00000014
r4   = 0xfffefca4, r5   = 0xb25b406c
r6   = 0x00596a98, r7   = 0x005b8710
r8   = 0xb25b3e78, r9   = 0x005b42b8
r10  = 0x00000033, fp   = 0xbe9ecc18
ip   = 0x00504468, sp   = 0xbe9eca20
lr   = 0xb42466d1, pc   = 0xb261d0dc
cpsr = 0x60000010
...
000dc000 008cc000 rw-p [heap]
b0dec000 b0df1000 r-xp /usr/lib/libhaptic-module.so
b2313000 b2324000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b2412000 b2414000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
...
Callstack Information (PID:2289)
Call Stack Count: 24
 0: GHSocket::ReceiveData() + 0x2a0 (0xb261d0dc) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1d0dc
 1: GHSocket::OnSocketReadyToReceive(Tizen::Net::Sockets::Socket&) + 0x58 (0xb261ce14) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1ce14
 2: (0xb25816d9) [/usr/lib/osp/libosp-net.so.1] + 0x8a6d9
 ...
 6: Tizen::Net::Sockets::_SocketImpl::OnGioEventCallback(_GIOChannel*, GIOCondition, void*) + 0x3d6 (0xb2572cbf) [/usr/lib/osp/libosp-net.so.1] + 0x7bcbf
...
18: OspMain + 0x1ac (0xb2653f6c) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xaf6c
