...
PID: 18403
Date: 2014-05-08 13:48:53(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 18403, uid 5000)

Register Information
r0   = 0x001542c8, r1   = 0xb266b9fc
r2   = 0x001542c8, r3   = 0xb4c3e459
r4   = 0x0014fbc8, r5   = 0x00153118
r6   = 0xbe9ec91c, r7   = 0xbe9ec7ac
r8   = 0xbe9ec81c, r9   = 0x0014fbcc
r10  = 0x00000000, fp   = 0xbe9ec328
ip   = 0xb266bb58, sp   = 0xbe9ec2d0
lr   = 0xb2612bb0, pc   = 0xb261fa34
cpsr = 0x60000010
...
000dc000 0017b000 rw-p [heap]
b2452000 b2455000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b245d000 b245e000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b2466000 b2470000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b249c000 b24b0000 r-xp /usr/lib/libnetwork.so.0.0.0
b24b9000 b24cd000 r-xp /usr/lib/libwifi-direct.so.0.0
b24d5000 b24dd000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b24de000 b24e7000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b24ef000 b25b4000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b25c2000 b25dc000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b25e6000 b25ef000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b25f8000 b263a000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
...
Callstack Information (PID:18403)
Call Stack Count: 43
 0: Tizen::Ui::IProgressPopupEventListener::IProgressPopupEventListener() + 0x24 (0xb261fa34) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x27a34
 1: GHController::GHController() + 0x50 (0xb2612bb0) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1abb0
 2: GHPlayerController::GHPlayerController() + 0x34 (0xb261c1d4) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x241d4
 3: FormMain::FormMain() + 0xc4 (0xb265ad70) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x14d70
 4: CardPairFormFactory::CreateFormN(Tizen::Base::String const&, Tizen::Base::String const&) + 0x130 (0xb2651870) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xb870
End of Call Stack
