...
PID: 13050
Date: 2014-05-13 17:08:03(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 13050, uid 5000)

Register Information
r0   = 0x001e4fe0, r1   = 0x001c1538
r2   = 0x0000006b, r3   = 0xb3735f3d
r4   = 0xb26cf6e1, r5   = 0xb26cf662
r6   = 0xfffed001, r7   = 0xfffc3b94
r8   = 0x00000002, r9   = 0xb25ef1ec
r10  = 0x001e4fe0, fp   = 0xbea01d50
ip   = 0xb6aa2b98, sp   = 0xbea016d0
lr   = 0xb42e656b, pc   = 0xb26c9c10
cpsr = 0x20000010
...
Callstack Information (PID:13050)
Call Stack Count: 26
 0: GHAttackhelperController::OnTransactionReadyToRead(Tizen::Base::String, Tizen::Base::String, Tizen::Web::Json::IJsonValue*) + 0xcd4 (0xb26c9c10) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x40c10
 1: GHController::OnTransactionReadyToRead(Tizen::Net::Http::HttpSession&, Tizen::Net::Http::HttpTransaction&, int) + 0x30c (0xb26a6c50) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1dc50
...
20: OspMain + 0x1ac (0xb26f1894) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xd894
