...
PID: 3176
Date: 2014-04-29 22:07:24(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 3176, uid 5000)

Register Information
r0   = 0x001946b0, r1   = 0x2fffffff
r2   = 0xb662e800, r3   = 0xb662e800
r4   = 0xb25c8658, r5   = 0xb25b406c
r6   = 0x005966e8, r7   = 0x005b8460
r8   = 0xb25b3e78, r9   = 0x005b4008
r10  = 0x00000033, fp   = 0xbe9ecc08
ip   = 0x000033a8, sp   = 0xbe9ecb68
lr   = 0xb265a014, pc   = 0xb265a01c
cpsr = 0x60000010
...
Call Stack Count: 25
 0: FormGameMulti::onMatchConnect() + 0x48 (0xb265a01c) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x1101c
 1: non-virtual thunk to FormGameMulti::onMatchConnect() + 0x20 (0xb265a1a0) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x111a0
 2: GHTurnbasedMatchController::OnSocketConnected(Tizen::Net::Sockets::Socket&) + 0x44 (0xb261dacc) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1dacc
End of Call Stack
