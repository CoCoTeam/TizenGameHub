...
PID: 11143
Date: 2014-05-20 01:17:49(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 11143, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00002b87
r2   = 0x00000006, r3   = 0x00002b87
r4   = 0x00000006, r5   = 0xb6c3ebe4
r6   = 0xb6c3e000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x000073b8
r10  = 0xb6a4f000, fp   = 0x00006eb8
ip   = 0xb6a4f4c0, sp   = 0xbefc4418
lr   = 0xb6b4555c, pc   = 0xb6b41760
cpsr = 0x28000010
...
000dc000 00dd0000 rw-p [heap]
b0dee000 b0df3000 r-xp /usr/lib/libhaptic-module.so
b2315000 b2326000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b2414000 b2416000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b2422000 b2427000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b245c000 b245f000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b2467000 b2468000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b2470000 b247a000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b24a6000 b24ba000 r-xp /usr/lib/libnetwork.so.0.0.0
b24c3000 b24d7000 r-xp /usr/lib/libwifi-direct.so.0.0
b24df000 b24e7000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b24e8000 b24f1000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b24f9000 b25be000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b25cc000 b25e9000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b25f2000 b260c000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b2616000 b261f000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b2628000 b267d000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
b2689000 b26b2000 r-xp /opt/usr/apps/riQlIAKKYh/bin/CardPair.exe
...
Callstack Information (PID:11143)
Call Stack Count: 35
 0: gsignal + 0x3c (0xb6b41760) [/lib/libc.so.6] + 0x2a760
 1: abort + 0x1ac (0xb6b4555c) [/lib/libc.so.6] + 0x2e55c
 2: __assert_fail + 0x10c (0xb6b3a63c) [/lib/libc.so.6] + 0x2363c
 3: SysAssertInternal + 0x7a (0xb4296c53) [/usr/lib/osp/libosp-appfw.so] + 0x132c53
 4: Tizen::Ui::_ContainerImpl::GetChild(int) const + 0x84 (0xb370a23d) [/usr/lib/osp/libosp-uifw.so] + 0x2d123d
 5: Tizen::Ui::_ContainerImpl::SearchControlByName(Tizen::Base::String const&, bool, bool) const + 0x6e (0xb370a2d3) [/usr/lib/osp/libosp-uifw.so] + 0x2d12d3
 6: Tizen::Ui::Container::GetControl(Tizen::Base::String const&, bool) const + 0x1e (0xb36debff) [/usr/lib/osp/libosp-uifw.so] + 0x2a5bff
 7: FormMain::loadCloudsaveFinished(int, Tizen::Base::String) + 0x150 (0xb26a8360) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x1f360
 8: non-virtual thunk to FormMain::loadCloudsaveFinished(int, Tizen::Base::String) + 0x30 (0xb26a8684) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x1f684
 9: GHCloudsaveController::OnTransactionReadyToRead(Tizen::Base::String, Tizen::Base::String, Tizen::Web::Json::IJsonValue*) + 0x468 (0xb2668bec) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x40bec
10: GHController::OnTransactionReadyToRead(Tizen::Net::Http::HttpSession&, Tizen::Net::Http::HttpTransaction&, int) + 0x3b8 (0xb26467f0) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1e7f0
End of Call Stack
