...
PID: 14512
Date: 2014-04-29 18:00:33(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 14512, uid 5000)

Register Information
r0   = 0x0051cf28, r1   = 0x00000000
r2   = 0xbe9ec710, r3   = 0x003dd6d0
r4   = 0xb263d938, r5   = 0xb263d996
r6   = 0x0060c6b8, r7   = 0x005c4398
r8   = 0xb25b7e78, r9   = 0x005c19e0
r10  = 0x0000002f, fp   = 0xbe9ec898
ip   = 0x003dd6d0, sp   = 0xbe9ec5d0
lr   = 0xb4244e9d, pc   = 0xb265859c
cpsr = 0x60000010
...
b2324000 b2329000 r-xp /usr/lib/libhaptic-module.so
b2427000 b2429000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
...
b2647000 b2662000 r-xp /opt/usr/apps/riQlIAKKYh/bin/CardPair.exe
...
Callstack Information (PID:14512)
Call Stack Count: 28
 0: FormGameMulti::shuffleCard(Tizen::Base::String) + 0x4bc (0xb265859c) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x1159c
 1: FormGameMulti::onMatchStart(Tizen::Base::String) + 0x8c (0xb26594a0) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x124a0
 2: non-virtual thunk to FormGameMulti::onMatchStart(Tizen::Base::String) + 0x24 (0xb2659524) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x12524
