...
PID: 5837
Date: 2014-04-29 23:39:54(GMT+0900)
...
r0   = 0xbe9ecb20, r1   = 0x7b4a0657
r2   = 0x00000000, r3   = 0x7b4a0657
r4   = 0xb4430940, r5   = 0x0051c790
r6   = 0xbe9ecb20, r7   = 0xb4430940
r8   = 0x0051c790, r9   = 0xffff4160
r10  = 0x00548850, fp   = 0x00548854
ip   = 0xb4430a58, sp   = 0xbe9ecaf0
lr   = 0xb426bff5, pc   = 0xb42688ba
cpsr = 0x30000030
...
000dc000 0095a000 rw-p [heap]
b231e000 b2323000 r-xp /usr/lib/libhaptic-module.so
b2421000 b2423000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b2458000 b245b000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b2463000 b2464000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b246c000 b2476000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b24a2000 b24b6000 r-xp /usr/lib/libnetwork.so.0.0.0
b24bf000 b24d3000 r-xp /usr/lib/libwifi-direct.so.0.0
b24db000 b24e3000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b24e4000 b24ed000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b24f5000 b25ba000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b25c8000 b25e2000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b25ec000 b25f5000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b25fe000 b263d000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
b2648000 b2662000 r-xp /opt/usr/apps/riQlIAKKYh/bin/CardPair.exe
...
Call Stack Count: 29
 0: Tizen::Base::Runtime::_Event::_ListenerInfo::operator=(Tizen::Base::Runtime::_Event::_ListenerInfo const&) + 0x5 (0xb42688ba) [/usr/lib/osp/libosp-appfw.so] + 0x1548ba
 1: (0xb426bff5) [/usr/lib/osp/libosp-appfw.so] + 0x157ff5
 2: Tizen::Base::Runtime::_Event::RemoveListener(Tizen::Base::Runtime::IEventListener const&) + 0xc4 (0xb4269801) [/usr/lib/osp/libosp-appfw.so] + 0x155801
 3: Tizen::Net::Sockets::_SocketImpl::Close() + 0xc2 (0xb256f037) [/usr/lib/osp/libosp-net.so.1] + 0x7a037
 4: Tizen::Net::Sockets::Socket::Close() + 0x42 (0xb256d59b) [/usr/lib/osp/libosp-net.so.1] + 0x7859b
 5: GHSocket::OnClose() + 0xf4 (0xb261ace8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cce8
 6: GHSocket::OnSocketClosed(Tizen::Net::Sockets::Socket&, Tizen::Net::Sockets::NetSocketClosedReason) + 0xa4 (0xb261aba8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cba8
 7: (0xb257f73d) [/usr/lib/osp/libosp-net.so.1] + 0x8a73d
...
11: Tizen::Net::Sockets::_SocketImpl::OnGioEventCallback(_GIOChannel*, GIOCondition, void*) + 0x588 (0xb2570e71) [/usr/lib/osp/libosp-net.so.1] + 0x7be71
...
23: OspMain + 0x1ac (0xb265303c) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xb03c
