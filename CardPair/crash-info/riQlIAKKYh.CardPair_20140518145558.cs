...
PID: 15524
Date: 2014-05-18 14:55:58(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 15524, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00003ca4
r2   = 0x00000006, r3   = 0x00003ca4
r4   = 0x00000006, r5   = 0xb6c91be4
r6   = 0xb6c91000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x000ce868
r10  = 0xb6aa2000, fp   = 0xbea01b90
ip   = 0xb6aa24c0, sp   = 0xbea01568
...
Callstack Information (PID:15524)
Call Stack Count: 49
 ...
 3: SysAssertInternal + 0x7a (0xb42e9c53) [/usr/lib/osp/libosp-appfw.so] + 0x132c53
 4: Tizen::Ui::_ContainerImpl::RemoveChild(Tizen::Ui::_ControlImpl*, bool) + 0xfc (0xb375cf41) [/usr/lib/osp/libosp-uifw.so] + 0x2d0f41
 5: Tizen::Ui::_ContainerImpl::AddChild(Tizen::Ui::_ControlImpl*, bool) + 0xbc (0xb375d061) [/usr/lib/osp/libosp-uifw.so] + 0x2d1061
 6: Tizen::Ui::Container::AddControl(Tizen::Ui::Control*) + 0x26 (0xb37317b7) [/usr/lib/osp/libosp-uifw.so] + 0x2a57b7
 7: GHAchievementController::loadAchievementForm() + 0xc4 (0xb26c8d1c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x45d1c
 8: FormSocial::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x164 (0xb26ffa7c) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x1ea7c
 9: non-virtual thunk to FormSocial::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb26ffb8c) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x1eb8c
End of Call Stack
