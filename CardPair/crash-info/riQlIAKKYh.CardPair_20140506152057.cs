...
PID: 3261
Date: 2014-05-06 15:20:57(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 3261, uid 5000)

Register Information
r0   = 0x0025a7b8, r1   = 0x00000000
r2   = 0x0025a7b8, r3   = 0x00000000
r4   = 0xb2689111, r5   = 0xb2689092
r6   = 0xffff7009, r7   = 0xfffc3b94
r8   = 0x00000002, r9   = 0xb25dc1ec
r10  = 0x0025a7c4, fp   = 0xbe9119e8
ip   = 0xb267bb80, sp   = 0xbe9119c8
lr   = 0xb267c090, pc   = 0xb267bb9c
cpsr = 0x60000010
...
000dc000 006cd000 rw-p [heap]
b20e6000 b20eb000 r-xp /usr/lib/libhaptic-module.so
...
Call Stack Count: 28
 0: AchievementForm::loadAchievementFinished(Tizen::Base::Collection::ArrayList*) + 0x1c (0xb267bb9c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x2bb9c
 1: non-virtual thunk to AchievementForm::loadAchievementFinished(Tizen::Base::Collection::ArrayList*) + 0x2c (0xb267c090) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x2c090
 2: GHAchievementController::OnTransactionReadyToRead(Tizen::Base::String, Tizen::Base::String, Tizen::Web::Json::IJsonValue*) + 0xa14 (0xb2687cb0) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x37cb0
 3: GHController::OnTransactionReadyToRead(Tizen::Net::Http::HttpSession&, Tizen::Net::Http::HttpTransaction&, int) + 0x30c (0xb266979c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1979c
 4: (0xb259028f) [/usr/lib/osp/libosp-net.so.1] + 0x4928f
 5: Tizen::Base::Runtime::_Event::ProcessListeners(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x2c0 (0xb42b71c5) [/usr/lib/osp/libosp-appfw.so] + 0x1561c5
 6: Tizen::Base::Runtime::_Event::Fire(std::tr1::shared_ptr<Tizen::Base::Runtime::IEventArg>) + 0x36 (0xb42b73fb) [/usr/lib/osp/libosp-appfw.so] + 0x1563fb
 7: Tizen::Base::Runtime::_Event::Fire(Tizen::Base::Runtime::IEventArg&) + 0x84 (0xb42b74ed) [/usr/lib/osp/libosp-appfw.so] + 0x1564ed
 8: (0xb25908ff) [/usr/lib/osp/libosp-net.so.1] + 0x498ff
 9: (0xb258fa1f) [/usr/lib/osp/libosp-net.so.1] + 0x48a1f
10: Tizen::Net::Http::_HttpTransactionImpl::OnSocketReceivedEvent(_GIOChannel*, GIOCondition, void*) + 0x80 (0xb2595075) [/usr/lib/osp/libosp-net.so.1] + 0x4e075
11: g_io_unix_dispatch + 0x2a (0xb6d0b783) [/usr/lib/libglib-2.0.so.0] + 0x64783
12: g_main_context_dispatch + 0xce (0xb6cdfa37) [/usr/lib/libglib-2.0.so.0] + 0x38a37
13: _ecore_glib_select + 0x3ae (0xb68fd337) [/usr/lib/libecore.so.1] + 0xf337
14: _ecore_main_select + 0x294 (0xb68f88b9) [/usr/lib/libecore.so.1] + 0xa8b9
15: _ecore_main_loop_iterate_internal + 0x2de (0xb68f92f3) [/usr/lib/libecore.so.1] + 0xb2f3
16: ecore_main_loop_begin + 0x30 (0xb68f95cd) [/usr/lib/libecore.so.1] + 0xb5cd
17: elm_run + 0x6 (0xb69c219f) [/usr/lib/libelementary.so.1] + 0xa819f
18: appcore_efl_main + 0x2d4 (0xb6f2b7d5) [/usr/lib/libappcore-efl.so.1] + 0x27d5
19: app_efl_main + 0xc6 (0xb3f0307f) [/usr/lib/libcapi-appfw-application.so.0] + 0x807f
20: Tizen::App::_AppImpl::Execute(Tizen::App::_IAppImpl*) + 0xe6 (0xb424e8b3) [/usr/lib/osp/libosp-appfw.so] + 0xed8b3
21: Tizen::App::UiApp::Execute(Tizen::App::UiApp* (*)(), Tizen::Base::Collection::IList const*) + 0x64 (0xb3ae1231) [/usr/lib/osp/libosp-uifw.so] + 0x6ab231
22: OspMain + 0x1ac (0xb269e478) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xb478
23: main + 0x194 (0xb412ef21) [/opt/apps/riQlIAKKYh/bin/CardPair] + 0xf21
...
26: __libc_start_main + 0x114 (0xb6b296e8) [/lib/libc.so.6] + 0x156e8
