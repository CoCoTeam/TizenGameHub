...
PID: 14178
Date: 2014-05-11 20:51:48(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 14178, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00003762
r2   = 0x00000006, r3   = 0x00003762
r4   = 0x00000006, r5   = 0xb6c47be4
r6   = 0xb6c47000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x00000000
r10  = 0xb6a58000, fp   = 0x00000000
ip   = 0xb6a584c0, sp   = 0xbe830c30
...
000dc000 00438000 rw-p [heap]
b0e39000 b0e3e000 r-xp /usr/lib/libhaptic-module.so
b2360000 b2371000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b245f000 b2461000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b246d000 b2472000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b24a7000 b24aa000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b24b2000 b24b3000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b24bb000 b24c5000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b24f1000 b2505000 r-xp /usr/lib/libnetwork.so.0.0.0
b250e000 b2522000 r-xp /usr/lib/libwifi-direct.so.0.0
b252a000 b2532000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b2533000 b253c000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b2544000 b2609000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b2617000 b2631000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b263b000 b2644000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b264d000 b2692000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
b269d000 b26bc000 r-xp /opt/usr/apps/riQlIAKKYh/bin/CardPair.exe
...
Callstack Information (PID:14178)
Call Stack Count: 36
 0: gsignal + 0x3c (0xb6b4a760) [/lib/libc.so.6] + 0x2a760
 1: abort + 0x1ac (0xb6b4e55c) [/lib/libc.so.6] + 0x2e55c
 2: __assert_fail + 0x10c (0xb6b4363c) [/lib/libc.so.6] + 0x2363c
 3: SysAssertInternal + 0x7a (0xb429fc53) [/usr/lib/osp/libosp-appfw.so] + 0x132c53
 4: (0xb396f589) [/usr/lib/osp/libosp-uifw.so] + 0x52d589
 5: (0xb3971029) [/usr/lib/osp/libosp-uifw.so] + 0x52f029
 6: (0xb3993325) [/usr/lib/osp/libosp-uifw.so] + 0x551325
 7: (0xb39969e5) [/usr/lib/osp/libosp-uifw.so] + 0x5549e5
 8: (0xb3996ae1) [/usr/lib/osp/libosp-uifw.so] + 0x554ae1
 9: Tizen::Ui::Controls::_TableView::OnDraw() + 0xc (0xb397751d) [/usr/lib/osp/libosp-uifw.so] + 0x53551d
10: Tizen::Ui::_ControlImpl::OnDraw() + 0x10 (0xb37058b1) [/usr/lib/osp/libosp-uifw.so] + 0x2c38b1
11: (0xb3967dad) [/usr/lib/osp/libosp-uifw.so] + 0x525dad
12: Tizen::Ui::_Control::ControlVisualElementContentProvider::PrepareDraw(Tizen::Ui::Animations::VisualElement&) + 0xb6 (0xb3701d0f) [/usr/lib/osp/libosp-uifw.so] + 0x2bfd0f
13: Tizen::Ui::Animations::_VisualElementImpl::InvokePrepareDraw() + 0x16 (0xb368a15b) [/usr/lib/osp/libosp-uifw.so] + 0x24815b
14: Tizen::Ui::Animations::_VisualElementImpl::DrawRectangle(Tizen::Graphics::FloatRectangle const&) + 0x2d4 (0xb368a46d) [/usr/lib/osp/libosp-uifw.so] + 0x24846d
15: Tizen::Ui::Animations::_VisualElementImpl::DrawRectangleIfNeeded(Tizen::Graphics::FloatRectangle const&) + 0x70 (0xb368a5c5) [/usr/lib/osp/libosp-uifw.so] + 0x2485c5
16: Tizen::Ui::Animations::_VisualElementImpl::DrawRectangleIfNeeded(Tizen::Graphics::FloatRectangle const&) + 0x112 (0xb368a667) [/usr/lib/osp/libosp-uifw.so] + 0x248667
17: Tizen::Ui::Animations::_VisualElementImpl::DrawRectangleIfNeeded(Tizen::Graphics::FloatRectangle const&) + 0x112 (0xb368a667) [/usr/lib/osp/libosp-uifw.so] + 0x248667
18: Tizen::Ui::Animations::_VisualElementImpl::Draw() + 0x9e (0xb368a78b) [/usr/lib/osp/libosp-uifw.so] + 0x24878b
19: Tizen::Ui::Animations::_DisplayManager::Render(Tizen::Ui::Animations::_RootVisualElement&) + 0x30 (0xb3674911) [/usr/lib/osp/libosp-uifw.so] + 0x232911
20: Tizen::Ui::Animations::_DisplayManager::RenderAll() + 0x36 (0xb36749bf) [/usr/lib/osp/libosp-uifw.so] + 0x2329bf
21: (0xb36994b1) [/usr/lib/osp/libosp-uifw.so] + 0x2574b1
22: _ecore_idle_enterer_call + 0x48 (0xb6903b85) [/usr/lib/libecore.so.1] + 0x9b85
23: _ecore_main_loop_iterate_internal + 0x42 (0xb6905057) [/usr/lib/libecore.so.1] + 0xb057
24: ecore_main_loop_begin + 0x30 (0xb69055cd) [/usr/lib/libecore.so.1] + 0xb5cd
25: elm_run + 0x6 (0xb69ce19f) [/usr/lib/libelementary.so.1] + 0xa819f
26: appcore_efl_main + 0x2d4 (0xb6f377d5) [/usr/lib/libappcore-efl.so.1] + 0x27d5
27: app_efl_main + 0xc6 (0xb3f0f07f) [/usr/lib/libcapi-appfw-application.so.0] + 0x807f
28: Tizen::App::_AppImpl::Execute(Tizen::App::_IAppImpl*) + 0xe6 (0xb425a8b3) [/usr/lib/osp/libosp-appfw.so] + 0xed8b3
29: Tizen::App::UiApp::Execute(Tizen::App::UiApp* (*)(), Tizen::Base::Collection::IList const*) + 0x64 (0xb3aed231) [/usr/lib/osp/libosp-uifw.so] + 0x6ab231
30: OspMain + 0x1ac (0xb26a96e4) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xc6e4
31: main + 0x194 (0xb413af21) [/opt/apps/riQlIAKKYh/bin/CardPair] + 0xf21
32: __launchpad_main_loop + 0xe54 (0xb259) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xb259
33: main + 0x486 (0xbcb3) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xbcb3
34: __libc_start_main + 0x114 (0xb6b356e8) [/lib/libc.so.6] + 0x156e8
35: (0xa110) [/usr/bin/launchpad_preloading_preinitializing_daemon] + 0xa110
End of Call Stack
