...
PID: 28973
Date: 2014-04-30 21:27:20(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 28973, uid 5000)

Register Information
r0   = 0x005ce5b8, r1   = 0x00000001
r2   = 0xb662e800, r3   = 0xb662e800
r4   = 0xb263d918, r5   = 0xb263d976
r6   = 0x001d0bb0, r7   = 0x004fed80
r8   = 0xb25b7e78, r9   = 0x0026bbc8
r10  = 0x00000033, fp   = 0xbe9ec8f8
ip   = 0x000033a8, sp   = 0xbe9ec710
lr   = 0xb2659920, pc   = 0xb2659928
cpsr = 0x60000010
...
Callstack Information (PID:28973)
Call Stack Count: 27
 0: FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x200 (0xb2659928) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x12928
 1: non-virtual thunk to FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x24 (0xb2659f58) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x12f58
 2: GHTurnbasedMatchController::ReceiveData(ListenerType::Type, Tizen::Base::String) + 0x1d8 (0xb2622124) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1e124
 3: GHSocket::ReceiveData() + 0x494 (0xb26213d8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1d3d8
 4: GHSocket::OnSocketReadyToReceive(Tizen::Net::Sockets::Socket&) + 0x58 (0xb2620f1c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cf1c
End of Call Stack
