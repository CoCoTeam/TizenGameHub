...
PID: 17294
Date: 2014-05-13 08:08:19(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 17294, uid 5000)

Register Information
r0   = 0x001f4620, r1   = 0x003477a0
r2   = 0x0000006b, r3   = 0xb3735f3d
r4   = 0xb26d23a1, r5   = 0xb26d2322
r6   = 0xfffed6c1, r7   = 0xfffc3b94
r8   = 0x00000002, r9   = 0xb25f31ec
r10  = 0x001f4620, fp   = 0xbea01d50
ip   = 0xb6aa2b98, sp   = 0xbea016d0
lr   = 0xb42e656b, pc   = 0xb26cc8d0
cpsr = 0x20000010
...
000dc000 0044a000 rw-p [heap]
b0e53000 b0e58000 r-xp /usr/lib/libhaptic-module.so
b237a000 b238b000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b2479000 b247b000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b2487000 b248c000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b24c1000 b24c4000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b24cc000 b24cd000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b24d5000 b24df000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b250b000 b251f000 r-xp /usr/lib/libnetwork.so.0.0.0
b2528000 b253c000 r-xp /usr/lib/libwifi-direct.so.0.0
b2544000 b254c000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b254d000 b2556000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b255e000 b2623000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b2631000 b264e000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b2657000 b2671000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b267b000 b2684000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b268d000 b26db000 r-xp /opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so
b26e6000 b2705000 r-xp /opt/usr/apps/riQlIAKKYh/bin/CardPair.exe
...
Callstack Information (PID:17294)
Call Stack Count: 26
 0: GHAttackhelperController::OnTransactionReadyToRead(Tizen::Base::String, Tizen::Base::String, Tizen::Web::Json::IJsonValue*) + 0xcd4 (0xb26cc8d0) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x3f8d0
 1: GHController::OnTransactionReadyToRead(Tizen::Net::Http::HttpSession&, Tizen::Net::Http::HttpTransaction&, int) + 0x30c (0xb26aa654) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1d654
 2: (0xb25a728f) [/usr/lib/osp/libosp-net.so.1] + 0x4928f
 ...
 6: (0xb25a78ff) [/usr/lib/osp/libosp-net.so.1] + 0x498ff
 7: (0xb25a6a1f) [/usr/lib/osp/libosp-net.so.1] + 0x48a1f
 8: Tizen::Net::Http::_HttpTransactionImpl::OnSocketReceivedEvent(_GIOChannel*, GIOCondition, void*) + 0x80 (0xb25ac075) [/usr/lib/osp/libosp-net.so.1] + 0x4e075
...
20: OspMain + 0x1ac (0xb26f2c4c) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xcc4c
