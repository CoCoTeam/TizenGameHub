...
PID: 13428
Date: 2014-04-29 17:27:32(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 13428, uid 5000)

Register Information
r0   = 0x005f9358, r1   = 0x00000000
r2   = 0xbe9ec874, r3   = 0x003856a0
r4   = 0xb263e938, r5   = 0xb263e996
r6   = 0x00379e60, r7   = 0x00622430
r8   = 0xb25b8e78, r9   = 0x002c0c48
r10  = 0x00000033, fp   = 0xbe9ec898
ip   = 0x003856a0, sp   = 0xbe9ec7d0
lr   = 0xb4244e9d, pc   = 0xb2659124
cpsr = 0x60000010
...
000dc000 00898000 rw-p [heap]
b2104000 b2106000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
...
Callstack Information (PID:13428)
Call Stack Count: 28
 0: FormGameMulti::shuffleCard(Tizen::Base::String) + 0xe0 (0xb2659124) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x11124
 1: FormGameMulti::onMatchStart(Tizen::Base::String) + 0x8c (0xb2659ffc) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x11ffc
 2: non-virtual thunk to FormGameMulti::onMatchStart(Tizen::Base::String) + 0x24 (0xb265a080) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x12080
