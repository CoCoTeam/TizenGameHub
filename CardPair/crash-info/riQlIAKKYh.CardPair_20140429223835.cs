...
PID: 4833
Date: 2014-04-29 22:38:35(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 4833, uid 5000)

Register Information
r0   = 0x00000022, r1   = 0x00000022
r2   = 0x00000000, r3   = 0x00000001
r4   = 0xfffef3b8, r5   = 0x000590f2
r6   = 0x00000022, r7   = 0x0042b910
r8   = 0xb25b2e78, r9   = 0x004d53c0
r10  = 0x00000030, fp   = 0xbe9ec960
ip   = 0xb26485a8, sp   = 0xbe9ec918
lr   = 0xb261bce8, pc   = 0xb256e560
cpsr = 0x20000030
...
000dc000 00b0f000 rw-p [heap]
b231f000 b2324000 r-xp /usr/lib/libhaptic-module.so
b2422000 b2424000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
...
Callstack Information (PID:4833)
Call Stack Count: 27
 0: Tizen::Net::Sockets::Socket::Close() + 0x7 (0xb256e560) [/usr/lib/osp/libosp-net.so.1] + 0x78560
 1: GHSocket::OnClose() + 0xf4 (0xb261bce8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cce8
 2: GHTurnbasedMatchController::ReceiveData(ListenerType::Type, Tizen::Base::String) + 0x128 (0xb261cfa8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1dfa8
 3: GHSocket::ReceiveData() + 0x494 (0xb261c30c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1d30c
 4: GHSocket::OnSocketReadyToReceive(Tizen::Net::Sockets::Socket&) + 0x58 (0xb261be50) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1ce50
...
21: OspMain + 0x1ac (0xb26540cc) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xb0cc
