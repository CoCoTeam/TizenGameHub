...
PID: 29863
Date: 2014-05-05 17:35:13(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 29863, uid 5000)

Register Information
r0   = 0x0c000000, r1   = 0x006266a8
r2   = 0x306266a8, r3   = 0x006266a8
r4   = 0xb263cad8, r5   = 0xb263cb36
r6   = 0x001b8468, r7   = 0x006b3648
r8   = 0xb25b6e78, r9   = 0x001f0270
r10  = 0x00000035, fp   = 0xbe9ec6d0
ip   = 0x00000001, sp   = 0xbe9ec670
lr   = 0xb26596f4, pc   = 0xb26554fc
cpsr = 0x60000010
...
Callstack Information (PID:29863)
Call Stack Count: 28
 0: FormGame::setCardVisible(int, bool) + 0x48 (0xb26554fc) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xf4fc
 1: FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x7b4 (0xb26596f4) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x136f4
 2: non-virtual thunk to FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x24 (0xb26597c8) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x137c8
 3: GHTurnbasedMatchController::ReceiveData(ListenerType::Type, Tizen::Base::String) + 0x1d8 (0xb2621124) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1e124
 4: GHSocket::ReceiveData() + 0x494 (0xb26203d8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1d3d8
 5: GHSocket::OnSocketReadyToReceive(Tizen::Net::Sockets::Socket&) + 0x58 (0xb261ff1c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cf1c
End of Call Stack
