...
PID: 3049
Date: 2014-04-29 22:04:41(GMT+0900)
...
r0   = 0x00000000, r1   = 0xbe9ec908
r2   = 0xb6bef248, r3   = 0xb4430940
r4   = 0x00058f8c, r5   = 0x00000000
r6   = 0x0057a790, r7   = 0x005b0728
r8   = 0xbe9ecd80, r9   = 0x000cdfa0
r10  = 0xb4430940, fp   = 0xbe9ec938
ip   = 0xb26485a8, sp   = 0xbe9ec878
lr   = 0xb261d6b0, pc   = 0xb256f6c4
cpsr = 0x60000030
...
000dc000 00851000 rw-p [heap]
b2416000 b241b000 r-xp /usr/lib/libhaptic-module.so
b2423000 b2425000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
...
Call Stack Count: 45
 0: Tizen::Net::Sockets::Socket::Send(Tizen::Base::ByteBuffer&) + 0x7 (0xb256f6c4) [/usr/lib/osp/libosp-net.so.1] + 0x786c4
 1: GHSocket::SendData(Tizen::Base::String) + 0x24c (0xb261d6b0) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1d6b0
 2: GHTurnbasedMatchController::sendDataToPlayer(Tizen::Base::String, int) + 0x210 (0xb261df10) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1df10
 3: FormGameMulti::sendClick(int) + 0x98 (0xb2659fe0) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x10fe0
 4: FormGame::OnActionPerformed(Tizen::Ui::Control const&, int) + 0xe0 (0xb2657dc4) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xedc4
 5: non-virtual thunk to FormGame::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb265809c) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xf09c
End of Call Stack
