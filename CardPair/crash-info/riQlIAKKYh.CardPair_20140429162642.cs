...
PID: 12289
Date: 2014-04-29 16:26:42(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 12289, uid 5000)

Register Information
r0   = 0x00000010, r1   = 0x00000010
r2   = 0x00000000, r3   = 0x00000001
r4   = 0xb263e63b, r5   = 0x000590f2
r6   = 0x00000010, r7   = 0x005ea6b8
r8   = 0xb25b8e78, r9   = 0x0060ca38
r10  = 0x0000002f, fp   = 0xbe9ecc00
ip   = 0xb26475ac, sp   = 0xbe9ecbb8
lr   = 0xb2621dd0, pc   = 0xb2574560
cpsr = 0x20000030
...
000dc000 00881000 rw-p [heap]
b2325000 b232a000 r-xp /usr/lib/libhaptic-module.so
...
Callstack Information (PID:12289)
Call Stack Count: 25
 0: Tizen::Net::Sockets::Socket::Close() + 0x7 (0xb2574560) [/usr/lib/osp/libosp-net.so.1] + 0x78560
 1: GHSocket::OnClose() + 0xf4 (0xb2621dd0) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cdd0
 2: GHSocket::OnSocketClosed(Tizen::Net::Sockets::Socket&, Tizen::Net::Sockets::NetSocketClosedReason) + 0xa4 (0xb2621c90) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cc90
 3: (0xb258673d) [/usr/lib/osp/libosp-net.so.1] + 0x8a73d
 ...
 7: Tizen::Net::Sockets::_SocketImpl::OnGioEventCallback(_GIOChannel*, GIOCondition, void*) + 0x588 (0xb2577e71) [/usr/lib/osp/libosp-net.so.1] + 0x7be71
...
19: OspMain + 0x1ac (0xb26530e4) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xb0e4
