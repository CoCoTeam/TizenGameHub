...
PID: 5613
Date: 2014-04-29 23:38:28(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 5613, uid 5000)

Register Information
r0   = 0x00000011, r1   = 0x00000011
r2   = 0x00000000, r3   = 0x00000001
r4   = 0xb263637f, r5   = 0x000590f2
r6   = 0x00000011, r7   = 0x001a5c28
r8   = 0xb25b1e78, r9   = 0x00618110
r10  = 0x00000033, fp   = 0xbe9ecc00
ip   = 0xb26475a8, sp   = 0xbe9ecbb8
lr   = 0xb261ace8, pc   = 0xb256d560
cpsr = 0x20000030
...
000dc000 00985000 rw-p [heap]
b223d000 b223f000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b2311000 b2322000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b240d000 b2412000 r-xp /usr/lib/libhaptic-module.so
b241e000 b2423000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
...
Callstack Information (PID:5613)
Call Stack Count: 25
 0: Tizen::Net::Sockets::Socket::Close() + 0x7 (0xb256d560) [/usr/lib/osp/libosp-net.so.1] + 0x78560
 1: GHSocket::OnClose() + 0xf4 (0xb261ace8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cce8
 2: GHSocket::OnSocketClosed(Tizen::Net::Sockets::Socket&, Tizen::Net::Sockets::NetSocketClosedReason) + 0xa4 (0xb261aba8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cba8
 3: (0xb257f73d) [/usr/lib/osp/libosp-net.so.1] + 0x8a73d
 ...
 7: Tizen::Net::Sockets::_SocketImpl::OnGioEventCallback(_GIOChannel*, GIOCondition, void*) + 0x588 (0xb2570e71) [/usr/lib/osp/libosp-net.so.1] + 0x7be71
...
19: OspMain + 0x1ac (0xb2653084) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xb084
