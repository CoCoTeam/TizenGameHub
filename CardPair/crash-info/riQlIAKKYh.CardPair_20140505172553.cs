...
PID: 29629
Date: 2014-05-05 17:25:53(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 29629, uid 5000)

Register Information
r0   = 0x42280000, r1   = 0x0063e2b4
r2   = 0xb4423418, r3   = 0xb4430940
r4   = 0xbe9ece2c, r5   = 0xbe9ece2c
r6   = 0xbe9ece64, r7   = 0x0063e2b4
r8   = 0xb3d4bd70, r9   = 0x000ce5d0
r10  = 0x001c3708, fp   = 0xbe9ecf50
ip   = 0xb4433468, sp   = 0xbe9ece20
lr   = 0xb42460dd, pc   = 0xb4243d56
cpsr = 0x60000030
...
Callstack Information (PID:29629)
Call Stack Count: 26
 0: Tizen::Base::String::~String() + 0xd (0xb4243d56) [/usr/lib/osp/libosp-appfw.so] + 0x12fd56
 1: Tizen::Base::String::operator=(Tizen::Base::String const&) + 0x20 (0xb42460dd) [/usr/lib/osp/libosp-appfw.so] + 0x1320dd
 2: Tizen::Ui::Controls::_Button::SetPropertyText(Tizen::Ui::Variant const&) + 0x1c (0xb3774635) [/usr/lib/osp/libosp-uifw.so] + 0x38b635
 3: (0xb3878135) [/usr/lib/osp/libosp-uifw.so] + 0x48f135
 4: Tizen::Ui::Controls::Button::SetText(Tizen::Base::String const&) + 0x18 (0xb374d6b5) [/usr/lib/osp/libosp-uifw.so] + 0x3646b5
 5: FormGame::setCardVisible(int, bool) + 0xac (0xb2655560) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xf560
 6: FormGame::OnTimerExpired(Tizen::Base::Runtime::Timer&) + 0x794 (0xb2655ef4) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xfef4
 7: non-virtual thunk to FormGame::OnTimerExpired(Tizen::Base::Runtime::Timer&) + 0x2c (0xb265651c) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x1051c
End of Call Stack
