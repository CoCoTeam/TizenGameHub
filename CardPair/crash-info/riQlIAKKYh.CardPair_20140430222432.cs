...
PID: 30930
Date: 2014-04-30 22:24:32(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 30930, uid 5000)

Register Information
r0   = 0x0064c81c, r1   = 0x01f62490
r2   = 0xffffffe4, r3   = 0x0064a1f8
r4   = 0xb4430940, r5   = 0x0000003b
r6   = 0x0064571d, r7   = 0xbe9ec690
r8   = 0x00000000, r9   = 0x00636e48
r10  = 0x00645758, fp   = 0xbe9ec740
ip   = 0x0000001c, sp   = 0xbe9ec63c
lr   = 0xb424532d, pc   = 0xb6b3a2cc
cpsr = 0x00000010
...
000dc000 00981000 rw-p [heap]
b0def000 b0df4000 r-xp /usr/lib/libhaptic-module.so
b2316000 b2327000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b2415000 b2417000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
...
Callstack Information (PID:30930)
Call Stack Count: 32
 0: memcpy + 0x8c (0xb6b3a2cc) [/lib/libc.so.6] + 0x732cc
 1: Tizen::Base::String::Remove(int, int) + 0x50 (0xb424532d) [/usr/lib/osp/libosp-appfw.so] + 0x13132d
 2: (0xb387815b) [/usr/lib/osp/libosp-uifw.so] + 0x48f15b
 3: Tizen::Ui::Controls::Button::SetText(Tizen::Base::String const&) + 0x18 (0xb374d6b5) [/usr/lib/osp/libosp-uifw.so] + 0x3646b5
 4: FormGame::setCardVisible(int, bool) + 0x60 (0xb26553a4) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0xf3a4
 5: FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x614 (0xb2659230) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x13230
 6: non-virtual thunk to FormGameMulti::onMatchMyturn(Tizen::Base::String) + 0x24 (0xb26593d8) [/opt/apps/riQlIAKKYh/bin/CardPair.exe] + 0x133d8
 7: GHTurnbasedMatchController::ReceiveData(ListenerType::Type, Tizen::Base::String) + 0x1d8 (0xb2621124) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1e124
 8: GHSocket::ReceiveData() + 0x494 (0xb26203d8) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1d3d8
 9: GHSocket::OnSocketReadyToReceive(Tizen::Net::Sockets::Socket&) + 0x58 (0xb261ff1c) [/opt/usr/apps/riQlIAKKYh/lib/libTizenGameHubLibrary.so] + 0x1cf1c
End of Call Stack
